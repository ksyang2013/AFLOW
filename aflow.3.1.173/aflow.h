...
// --------------------------------------------------------------------------
// extern for libraries
// [OBSOLETE] extern string Library_HTQC; // aflow_xproto.cpp
// [OBSOLETE] extern string Library_ICSD; // ALL OF THEM
// [OBSOLETE] extern vector<string> vLibrary_ICSD; // ALL OF THEM
// extern string aflowlib_lib3;  // aflow_data_libraries.cpp
// [OBSOLETE] extern string aflowlib_lib1;      // aflow_data_libraries.cpp
// extern string aflowlib_icsd;      // aflow_data_libraries.cpp
// --------------------------------------------------------------------------
...
#define DEFAULT_KZIP_BIN              string("bzip2")
...
#define DEFAULT_CHMOD_BIN             string("chmod") // string("chmod --quiet")
#define DEFAULT_KBIN_CONVERT_BIN      string("convert")
#define DEFAULT_KBIN_EPSTOPDF_BIN     string("epstopdf")
...
#define _FILE_AFLOWLIB_ENTRY_OUT_        string("aflowlib.out")
#define _FILE_AFLOWLIB_ENTRY_JSON_       string("aflowlib.json")
#define _FILE_EDATA_ORIG_OUT_            string("edata.orig.out")
#define _FILE_EDATA_RELAX_OUT_           string("edata.relax.out")
#define _FILE_EDATA_BANDS_OUT_           string("edata.bands.out")
#define _FILE_DATA_ORIG_OUT_             string("data.orig.out")
#define _FILE_DATA_RELAX_OUT_            string("data.relax.out")
#define _FILE_DATA_BANDS_OUT_            string("data.bands.out")
#define _FILE_EDATA_ORIG_JSON_            string("edata.orig.json")
#define _FILE_EDATA_RELAX_JSON_           string("edata.relax.json")
#define _FILE_EDATA_BANDS_JSON_           string("edata.bands.json")
#define _FILE_DATA_ORIG_JSON_             string("data.orig.json")
#define _FILE_DATA_RELAX_JSON_            string("data.relax.json")
#define _FILE_DATA_BANDS_JSON_            string("data.bands.json")
#define _FILE_TIME_OUT_                  string("time")
#define _FILE_SPACEGROUP1_OUT_           string("SpaceGroup")
#define _FILE_SPACEGROUP2_OUT_           string("SpaceGroup2")
#define _FILE_VOLDISTPARAMS_OUT_         string("VOLDISTParams")
#define _FILE_VOLDISTEVOLUTION_OUT_      string("VOLDISTEvolution")
...
#define _AFLOW_PRESCRIPT_FILE_           string("aflow.prescript.out")
#define _AFLOW_PRESCRIPT_COMMAND_        string("aflow.prescript.command")
#define _AFLOW_POSTSCRIPT_FILE_          string("aflow.postscript.out")
#define _AFLOW_POSTSCRIPT_COMMAND_       string("aflow.postscript.command")

#define _AFLOW_PGROUP_FILE_              string("aflow.pgroup.out")
#define _AFLOW_PGROUP_XTAL_FILE_         string("aflow.pgroup_xtal.out")
#define _AFLOW_PGROUPK_FILE_             string("aflow.pgroupk.out")
#define _AFLOW_PGROUPK_XTAL_FILE_        string("aflow.pgroupk_xtal.out") //DX 12/5/17 - Added pgroupk_xtal
#define _AFLOW_FGROUP_FILE_              string("aflow.fgroup.out")
#define _AFLOW_SGROUP_FILE_              string("aflow.sgroup.out")
#define _AFLOW_AGROUP_FILE_              string("aflow.agroup.out")
#define _AFLOW_IATOMS_FILE_              string("aflow.iatoms.out")
#define _AFLOW_PGROUP_JSON_              string("aflow.pgroup.json")      //DX 8/2/17 - Add JSON
#define _AFLOW_PGROUP_XTAL_JSON_         string("aflow.pgroup_xtal.json") //DX 8/2/17 - Add JSON
#define _AFLOW_PGROUPK_JSON_             string("aflow.pgroupk.json")     //DX 8/2/17 - Add JSON
#define _AFLOW_PGROUPK_XTAL_JSON_        string("aflow.pgroupk_xtal.json")//DX 8/2/17 - Add JSON //DX 12/5/17 - Added pgroupk_xtal
#define _AFLOW_FGROUP_JSON_              string("aflow.fgroup.json")      //DX 8/2/17 - Add JSON
#define _AFLOW_SGROUP_JSON_              string("aflow.sgroup.json")      //DX 8/2/17 - Add JSON
#define _AFLOW_AGROUP_JSON_              string("aflow.agroup.json")      //DX 8/2/17 - Add JSON
#define _AFLOW_IATOMS_JSON_              string("aflow.iatoms.json")      //DX 8/2/17 - Add JSON
// [OBSOLETE] #define _AFLOW_PHONON_FILE_  string("aflow.phonons.out")
#define _AFLOW_ICAGES_FILE_              string("aflow.icages.out")
#define _AFLOW_SURFACE_FILE_             string("aflow.surface.out")
#define _AFLOW_QMVASP_FILE_              string("aflow.qmvasp.out")
#define _AFLOW_ERVASP_FILE_              string("aflow.error.out")
#define _AFLOW_IMMISCIBILITY_FILE_       string("aflow.immiscibility.out")
#define _AFLOW_MEMORY_FILE_              string("aflow.memory.out")
#define _AFLOW_FROZSL_INPUT_FILE_        string("aflow.frozsl_input.out")
#define _AFLOW_FROZSL_POSCAR_FILE_       string("aflow.frozsl_poscar.out")
#define _AFLOW_FROZSL_MODES_FILE_        string("aflow.frozsl_energies.out")
#define _AFLOW_FROZSL_EIGEN_FILE_        string("aflow.frozsl_eigen.out")
#define _AFLOW_END_FILE_                 string("aflow.end.out")
...
#define XHOST_README_AFLOW_LICENSE_GPL3_TXT            XHOST.vGlobal_string.at(30)
#define XHOST_README_AFLOW_TXT                         XHOST.vGlobal_string.at(31)
#define XHOST_README_AFLOW_VERSIONS_HISTORY_TXT        XHOST.vGlobal_string.at(32)
#define XHOST_README_AFLOW_PFLOW_TXT                   XHOST.vGlobal_string.at(33)
#define XHOST_README_AFLOW_APENNSY_TXT                 XHOST.vGlobal_string.at(34)
#define XHOST_README_AFLOW_SCRIPTING_TXT               XHOST.vGlobal_string.at(35)
#define XHOST_README_AFLOW_FROZSL_TXT                  XHOST.vGlobal_string.at(36)
#define XHOST_README_AFLOW_POCC_TXT                    XHOST.vGlobal_string.at(37)
#define XHOST_README_AFLOW_APL_TXT                     XHOST.vGlobal_string.at(38)
#define XHOST_README_AFLOW_AGL_TXT                     XHOST.vGlobal_string.at(39)
#define XHOST_README_AFLOW_AEL_TXT                     XHOST.vGlobal_string.at(40)
#define XHOST_README_AFLOW_ANRL_TXT                    XHOST.vGlobal_string.at(41)
#define XHOST_README_AFLOW_COMPARE_TXT                 XHOST.vGlobal_string.at(42)
#define XHOST_README_AFLOW_SYMMETRY_TXT                XHOST.vGlobal_string.at(43)
#define XHOST_README_AFLOW_CHULL_TXT                   XHOST.vGlobal_string.at(44)
#define XHOST_README_AFLOW_HTRESOURCES_TXT             XHOST.vGlobal_string.at(45)
#define XHOST_README_PROTO_TXT                         XHOST.vGlobal_string.at(46)

#define XHOST_FINDSYM_data_space_txt                   XHOST.vGlobal_string.at(50)
#define XHOST_FINDSYM_data_wyckoff_txt                 XHOST.vGlobal_string.at(51)
#define XHOST_FROZSL_data_space_txt                    XHOST.vGlobal_string.at(52)
#define XHOST_FROZSL_data_wyckoff_txt                  XHOST.vGlobal_string.at(53)
#define XHOST_FROZSL_data_images_txt                   XHOST.vGlobal_string.at(54)
#define XHOST_FROZSL_data_irreps_txt                   XHOST.vGlobal_string.at(55)
#define XHOST_FROZSL_data_isotropy_txt                 XHOST.vGlobal_string.at(56)
#define XHOST_FROZSL_data_little_txt                   XHOST.vGlobal_string.at(57)
#define XHOST_FROZSL_symmetry2_dat                     XHOST.vGlobal_string.at(58)
#define XHOST_FROZSL_const_dat                         XHOST.vGlobal_string.at(59)
#define XHOST_FROZSL_phvaspsetup_AFLOW                 XHOST.vGlobal_string.at(60)
#define XHOST_FROZSL_phvaspsetup_POSCAR                XHOST.vGlobal_string.at(61)
#define XHOST_ElectronStoppingPower_txt                XHOST.vGlobal_string.at(62)
#define XHOST_PhotonCrossSection_txt                   XHOST.vGlobal_string.at(63)
#define XHOST_PhotonStoppingPower_txt                  XHOST.vGlobal_string.at(64)
#define XHOST_ICSD_List_txt                            XHOST.vGlobal_string.at(65)
#define XHOST_f144468a7ccc2d3a72ba44000715efdb                   XHOST.vGlobal_string.at(66)
#define XHOST_d0f1b0e47f178ae627a388d3bf65d2d2                   XHOST.vGlobal_string.at(67)
#define XHOST_decf00ca3ad2fe494eea8e543e929068                   XHOST.vGlobal_string.at(68)
// [OBSOLETE] #define XHOST_AFLOW_BinaryRead                     XHOST.vGlobal_string.at(69)
// [OBSOLETE] #define XHOST_AFLOW_Binary_Angle_Read              XHOST.vGlobal_string.at(70)
...
class _aflags {
 public:
  ...
  // aflow_xaflow.cpp contains the code
  // CONTENT
  bool QUIET;
...
class xstructure {
 public:
  ...
  double partial_occupation_tol;                                // tolerance for partial occupation >=0.0
...
string GetSpaceGroupSchoenflies(int spacegroupnumber); //DX 9/1/17
string GetSpaceGroupHall(int spacegroupnumber); //DX 9/1/17
string GetLaueLabel(string& point_group); //DX 9/1/17
...
// aflow_xproto.cpp
#define _GUS_STRING_ "(gus library)"
#define _HTQC_STRING_ "(htqc library)"
#define _HTQC_PROJECT_STRING_ "HTQC Project"
#define _TERNARY_STRING_ "(htqc^3)"
...
// ----------------------------------------------------------------------------
// aflow_anrl.cpp
#define DOI_ANRL " [ANRL doi: arXiv:1607.02532]"
...
namespace anrl {
  ...
  bool PrototypeANRL_Consistency(ostream &oss,uint vparameters_size,uint proto_nparameters,string proto_prototype,
                                 ...
                                 uint proto_spacegroup, string proto_params);
...
namespace KBIN {
  ...
  bool VASP_Produce_INCAR(_xvasp& xvasp,string AflowIn,ofstream& FileERROR,_aflags& aflags,_kflags& kflags,_vflags& vflags);
  ...
  bool VASP_Produce_POSCAR(_xvasp& xvasp,string AflowIn,ofstream& FileERROR,_aflags& aflags,_kflags& kflags,_vflags& vflags);
  bool VASP_Produce_POSCAR(_xvasp& xvasp);
  bool VASP_Modify_POSCAR(_xvasp& xvasp,string AflowIn,ofstream& FileERROR,_aflags& aflags,_vflags& vflags);
  bool VASP_Reread_POSCAR(_xvasp& xvasp,ofstream &FileMESSAGE,_aflags &aflags);
  bool VASP_Produce_KPOINTS(_xvasp& xvasp,string AflowIn,ofstream& FileERROR,_aflags& aflags,_kflags& kflags,_vflags& vflags);
  ...
  bool VASP_Produce_POTCAR(_xvasp& xvasp,string AflowIn,ofstream& FileERROR,_aflags& aflags,_kflags& kflags,_vflags& vflags);
...
#define _AVASP_PSEUDOPOTENTIAL_POT_LDA_ string("pot_LDA")
#define _AVASP_PSEUDOPOTENTIAL_POT_GGA_ string("pot_GGA")
#define _AVASP_PSEUDOPOTENTIAL_POT_PBE_ string("pot_PBE")
#define _AVASP_PSEUDOPOTENTIAL_POTPAW_LDA_ string("potpaw_LDA")
#define _AVASP_PSEUDOPOTENTIAL_POTPAW_GGA_ string("potpaw_GGA")
#define _AVASP_PSEUDOPOTENTIAL_POTPAW_PBE_ string("potpaw_PBE")
...
bool AVASP_MakeSingleAFLOWIN(_xvasp& xvaspin,stringstream &_aflowin,bool flag_WRITE,int=-1);   // last is pthread number, if <0 then serial
bool AVASP_MakeSingleAFLOWIN(_xvasp& xvasp_in,bool flag_WRITE,int=-1);  // last is pthread number, if <0 then serial
bool AVASP_MakeSingleAFLOWIN(_xvasp& xvasp_in,int=-1);  // last is pthread number, if <0 then serial
...
class xCHGCAR {
 public:
  ...
  xtensor3<double> tvalues; // ORIGIN                             // xtensor of values
  bool GetProperties(const stringstream& stringstreamIN,bool=TRUE);       // get everything QUIET
  bool GetProperties(const string& stringIN,bool=TRUE);                   // get everything QUIET
  bool GetPropertiesFile(const string& fileIN,bool=TRUE);                 // get everything QUIET
  bool GetPropertiesUrlFile(const string& url,const string& file,bool=TRUE); // get everything from an aflowlib entry
...
namespace SYM {
  //DX AND CO - START
  bool ApplyAtomValidate(const _atom &atom_in,_atom& atom_out,const _sym_op &symop,xstructure& a); //DX AND CO
  bool ApplyAtomValidate(const _atom &atom_in,_atom& atom_out,const _sym_op &symop,xstructure& a, bool _incell_,bool roff); //DX AND CO
  bool ApplyAtomValidate(const _atom &atom_in,_atom& atom_out,const _sym_op &symop,xstructure& a,bool skew, bool _incell_,bool roff,double _eps_); //DX AND CO
  bool ApplyAtomValidate(const _atom &atom_in,_atom& atom_out,const _sym_op &symop,xmatrix<double>& lattice,xmatrix<double>& c2f, xmatrix<double>& f2c,bool skew, bool _incell_,bool roff,double _eps_); //DX AND CO
  ...
  _atom ApplyAtom(const _atom& atom_in,const _sym_op& symop,xmatrix<double>& lattice,xmatrix<double>& c2f, xmatrix<double>& f2c,bool skew,bool _incell_,bool roff,bool validatePosition,double eps); //DX
  _atom ApplyAtom_20161115(const _atom& atom_in,const _sym_op& symop,xmatrix<double>& lattice,xmatrix<double>& c2f, xmatrix<double>& f2c,bool skew,bool _incell_,bool roff,bool validatePosition,double eps); //DX
  ...
  bool minimizeCartesianDistance(const xvector<double>& coord1, const xvector<double>& coord2, xvector<double>& out, xmatrix<double>& c2f, xmatrix<double>& f2c, double& tol);
  bool minimizeCartesianDistance(const xvector<double>& coord1, const xvector<double>& coord2, xvector<double>& out, xmatrix<double>& c2f, xmatrix<double>& f2c, xvector<int>& ijk, bool& restriction, double& tol);
  double minimumCartesianDistance(const xvector<double>& coord1, const xvector<double>& coord2, xmatrix<double>& lattice);
  double minimumCartesianDistance(const xvector<double>& coord1, const xvector<double>& coord2, xmatrix<double>& lattice,xvector<double>& min_vec,xvector<int>& ijk);
  ...
  bool validateAtomPosition(const _atom& atom,xmatrix<double>& c2f,xmatrix<double>& f2c,bool& skew,double& _eps_);
  bool validateAtomPosition(const xvector<double>& cpos,const xvector<double>& fpos,xmatrix<double>& c2f,xmatrix<double>& f2c,bool& skew,double& _eps_);
  ...
  bool isLatticeSkewed(xmatrix<double>& lattice, double& min_dist, double& tol);
  ...
  double defaultTolerance(xstructure& xstr);
