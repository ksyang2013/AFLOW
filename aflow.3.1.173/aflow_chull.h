...
namespace chull {
  ...
  void flagCheck(aurostd::xoption& vpflow, ostream& oss=cout, bool silent=false);
  void flagCheck(aurostd::xoption& vpflow, ofstream& FileMESSAGE, ostream& oss=cout, bool silent=false);
  ////////////////////////////////////////////////////////////////////////////////
  //stability criterion calculation
  bool stabilityCriterion(const vector<string>& velements,const string& auid,double& scriterion,ostream& oss=cout);
  bool stabilityCriterion(const vector<string>& velements,const string& auid,double& scriterion,ofstream& FileMESSAGE,ostream& oss=cout);
  bool stabilityCriterion(const vector<string>& velements,const vector<string>& vauid,vector<double>& vscriterion,ostream& oss=cout);
  bool stabilityCriterion(const vector<string>& velements,const vector<string>& vauid,vector<double>& vscriterion,ofstream& FileMESSAGE,ostream& oss=cout);
  bool stabilityCriterion(const aurostd::xoption& vpflow,const vector<string>& velements,double& scriterion,ostream& oss=cout);
  bool stabilityCriterion(const aurostd::xoption& vpflow,const vector<string>& velements,double& scriterion,ofstream& FileMESSAGE,ostream& oss=cout);
  bool stabilityCriterion(const aurostd::xoption& vpflow,const vector<string>& velements,const string& auid,double& scriterion,ostream& oss=cout);
  bool stabilityCriterion(const aurostd::xoption& vpflow,const vector<string>& velements,const string& auid,double& scriterion,ofstream& FileMESSAGE,ostream& oss=cout);
  bool stabilityCriterion(const aurostd::xoption& vpflow,const vector<string>& velements,vector<double>& vscriterion,ostream& oss=cout);
  bool stabilityCriterion(const aurostd::xoption& vpflow,const vector<string>& velements,vector<double>& vscriterion,ofstream& FileMESSAGE,ostream& oss=cout);
  bool stabilityCriterion(const aurostd::xoption& vpflow,const vector<string>& velements,const vector<string>& vauid,vector<double>& vscriterion,ostream& oss=cout);
  bool stabilityCriterion(const aurostd::xoption& vpflow,const vector<string>& velements,const vector<string>& vauid,vector<double>& vscriterion,ofstream& FileMESSAGE,ostream& oss=cout);
  ////////////////////////////////////////////////////////////////////////////////
  // returns value in desired units
  double convertUnits(double value, char units=_std_);
  double Hf_atom(const ChullPoint& point, char units=_std_);
  double Hf_atom(const aflowlib::_aflowlib_entry& entry, char units=_std_);
  double dist2Hull(const ChullPoint& point, char units=_std_);
  double Ts(const ChullPoint& point);
  double Ts(const aflowlib::_aflowlib_entry& entry);
  ////////////////////////////////////////////////////////////////////////////////
...
namespace chull {
  class ChullPoint {
    public:
      ...
      //constructors - START
      ChullPoint(bool has_stoich_coords=false,bool is_artificial=false,ostream& oss=cout);
      ChullPoint(const xvector<double>& coord,bool has_stoich_coords=false,bool is_artificial=false,ostream& oss=cout);
      ChullPoint(const vector<string>& velements,const aflowlib::_aflowlib_entry& entry,bool formation_energy_hull=true,ostream& oss=cout);
      ChullPoint(ofstream& FileMESSAGE,bool has_stoich_coords=false,bool is_artificial=false,ostream& oss=cout);
      ChullPoint(const xvector<double>& coord,ofstream& FileMESSAGE,bool has_stoich_coords=false,bool is_artificial=false,ostream& oss=cout);
      ChullPoint(const vector<string>& velements,const aflowlib::_aflowlib_entry& entry,ofstream& FileMESSAGE,bool formation_energy_hull=true,ostream& oss=cout);
      ...
      xvector<double> m_decomp_coefs; //un-reduced coefficients here, reduced exist at the m_coord_groups level

      //initialization methods
      bool initialize(bool has_stoich_coords=false,bool is_artificial=false,ostream& oss=cout);
      bool initialize(const xvector<double>& coord,bool has_stoich_coords=false,bool is_artificial=false,ostream& oss=cout);
      bool initialize(const vector<string>& velements,const aflowlib::_aflowlib_entry& entry,bool formation_energy_hull=true,ostream& oss=cout);
      bool initialize(ofstream& FileMESSAGE,bool has_stoich_coords=false,bool is_artificial=false,ostream& oss=cout);
      bool initialize(const xvector<double>& coord,ofstream& FileMESSAGE,bool has_stoich_coords=false,bool is_artificial=false,ostream& oss=cout);
      bool initialize(const vector<string>& velements,const aflowlib::_aflowlib_entry& entry,ofstream& FileMESSAGE,bool formation_energy_hull=true,ostream& oss=cout);
      
      //getters
      bool isGState() const;
      xvector<double> getTruncatedGenCoords() const; //reduced coords
      xvector<double> getTruncatedCoords(const xvector<double>& coords,const xvector<int>& elements_present) const;
      xvector<double> getTruncatedStoich(const xvector<int>& elements_present) const; //reduced stoichiometry
      xvector<double> getTruncatedComp(const xvector<int>& elements_present) const; //similar to reduced stoich, but in integer form (if not POCC)
      xvector<double> getRedComp() const;
    ...
    private:
      ...
      bool new_ofstream;  //for deletion later
      ...
      //initialization methods
      void initializeCoords(const xvector<double>& coord);
      void initializeCoords(const vector<string>& velements,const aflowlib::_aflowlib_entry& entry,bool formation_energy_hull=true);
      void addEntry(const aflowlib::_aflowlib_entry& entry);
      void setGenCoords(const xvector<double>& coord);
      void setGenCoords(const vector<string>& velements,const aflowlib::_aflowlib_entry& entry,bool formation_energy_hull=true);

      //hull specific methods
      vector<uint> getRelevantIndices(const xvector<int>& elements_present) const;
      void setStoichCoords();
      void cleanPoint();  //clean hull state of point
  };
} // namespace chull
...
namespace chull {
  class ChullFacet {
    public:
      ...
      double pointPlaneDistance(const ChullPoint& point) const;
      double pointPlaneDistance(const xvector<double>& point) const;
      double zeroPointProjectionDistance(const ChullPoint& point) const;
      double zeroPointProjectionDistance(const xvector<double>& point) const;
      double verticalDistance(const ChullPoint& point,bool zero_point_projection_only=false) const;
      double verticalDistance(const xvector<double>& point,bool zero_point_projection_only=false) const;
...
namespace chull {
  class CoordGroup {
    public:
      ...
      //attributes
      bool m_initialized;
      xvector<double> m_coords;     // ChullPoint.getTruncatedGenCoords(), as in reduced coordinates
      ...
      vector<uint> m_hull_points;   // also points to ChullPoints, refers to extremes of CoordGroup (half_hull's only has extrema)
...
namespace chull {
  class ConvexHull {
    public:
      ...
      ConvexHull(const vector<xvector<double> >& vcoords,ostream& _oss=cout,bool has_stoich_coords=false,bool half_hull=false,bool add_artificial_unaries=false);
      ConvexHull(const vector<ChullPoint>& vpoints,ostream& _oss=cout,bool half_hull=false,bool add_artificial_unaries=false);
      ConvexHull(const vector<ChullPoint>& vpoints,const vector<string>& velements,ostream& _oss=cout,bool half_hull=false,bool add_artificial_unaries=false);
      ...
      ConvexHull(const vector<xvector<double> >& vcoords,ofstream& FileMESSAGE,ostream& _oss=cout,bool has_stoich_coords=false,bool half_hull=false,bool add_artificial_unaries=false);
      ConvexHull(const vector<ChullPoint>& vpoints,ofstream& FileMESSAGE,ostream& _oss=cout,bool half_hull=false,bool add_artificial_unaries=false);
      ConvexHull(const vector<ChullPoint>& vpoints,const vector<string>& velements,ofstream& FileMESSAGE,ostream& _oss=cout,bool half_hull=false,bool add_artificial_unaries=false);
      ...
      ConvexHull(const aurostd::xoption& vpflow,const vector<xvector<double> >& vcoords,ostream& _oss=cout,bool has_stoich_coords=false,bool half_hull=false,bool add_artificial_unaries=false);
      ConvexHull(const aurostd::xoption& vpflow,const vector<ChullPoint>& vpoints,ostream& _oss=cout,bool half_hull=false,bool add_artificial_unaries=false);
      ConvexHull(const aurostd::xoption& vpflow,const vector<ChullPoint>& vpoints,const vector<string>& velements,ostream& _oss=cout,bool half_hull=false,bool add_artificial_unaries=false);
      ...
      ConvexHull(const aurostd::xoption& vpflow,const vector<xvector<double> >& vcoords,ofstream& FileMESSAGE,ostream& _oss=cout,bool has_stoich_coords=false,bool half_hull=false,bool add_artificial_unaries=false);
      ConvexHull(const aurostd::xoption& vpflow,const vector<ChullPoint>& vpoints,ofstream& FileMESSAGE,ostream& _oss=cout,bool half_hull=false,bool add_artificial_unaries=false);
      ConvexHull(const aurostd::xoption& vpflow,const vector<ChullPoint>& vpoints,const vector<string>& velements,ofstream& FileMESSAGE,ostream& _oss=cout,bool half_hull=false,bool add_artificial_unaries=false);
      ...
      bool initialize(const vector<xvector<double> >& vcoords,ostream& _oss=cout,bool has_stoich_coords=false,bool half_hull=false,bool add_artificial_unaries=false);
      bool initialize(const vector<ChullPoint>& vpoints,ostream& _oss=cout,bool half_hull=false,bool add_artificial_unaries=false);
      bool initialize(const vector<ChullPoint>& vpoints,const vector<string>& velements,ostream& _oss=cout,bool half_hull=false,bool add_artificial_unaries=false);
      ...
      bool initialize(const vector<xvector<double> >& vcoords,ofstream& FileMESSAGE,ostream& _oss=cout,bool has_stoich_coords=false,bool half_hull=false,bool add_artificial_unaries=false);
      bool initialize(const vector<ChullPoint>& vpoints,ofstream& FileMESSAGE,ostream& _oss=cout,bool half_hull=false,bool add_artificial_unaries=false);
      bool initialize(const vector<ChullPoint>& vpoints,const vector<string>& velements,ofstream& FileMESSAGE,ostream& _oss=cout,bool half_hull=false,bool add_artificial_unaries=false);
      ...
      bool initialize(const aurostd::xoption& vpflow,const vector<xvector<double> >& vcoords,ostream& _oss=cout,bool has_stoich_coords=false,bool half_hull=false,bool add_artificial_unaries=false);
      bool initialize(const aurostd::xoption& vpflow,const vector<ChullPoint>& vpoints,ostream& _oss=cout,bool half_hull=false,bool add_artificial_unaries=false);
      bool initialize(const aurostd::xoption& vpflow,const vector<ChullPoint>& vpoints,const vector<string>& velements,ostream& _oss=cout,bool half_hull=false,bool add_artificial_unaries=false);
      ...
      bool initialize(const aurostd::xoption& vpflow,const vector<xvector<double> >& vcoords,ofstream& FileMESSAGE,ostream& _oss=cout,bool has_stoich_coords=false,bool half_hull=false,bool add_artificial_unaries=false);
      bool initialize(const aurostd::xoption& vpflow,const vector<ChullPoint>& vpoints,ofstream& FileMESSAGE,ostream& _oss=cout,bool half_hull=false,bool add_artificial_unaries=false);
      bool initialize(const aurostd::xoption& vpflow,const vector<ChullPoint>& vpoints,const vector<string>& velements,ofstream& FileMESSAGE,ostream& _oss=cout,bool half_hull=false,bool add_artificial_unaries=false);
      ...
      void initializePoints(const vector<xvector<double> >& vcoords,bool has_stoich_coords=false,bool half_hull=false,bool add_artificial_unaries=false);
      void initializePoints(const vector<ChullPoint>& vpoints,bool half_hull=false,bool add_artificial_unaries=false);
      void initializePoints(const vector<ChullPoint>& vpoints,const vector<string>& velements,bool half_hull=false,bool add_artificial_unaries=false);
      ...
      double getDistanceToHull(uint i_point) const;
      double getDistanceToHull(const ChullPoint& point) const;
      ...
      xvector<double> getDecompositionCoefficients(uint i_point,bool reduce=true) const;
      xvector<double> getDecompositionCoefficients(const ChullPoint& point,bool reduce=true) const;
      xvector<double> getDecompositionCoefficients(uint i_point,const vector<uint>& decomp_phases,bool reduce=true) const;
      xvector<double> getDecompositionCoefficients(const ChullPoint& point,const vector<uint>& decomp_phases,bool reduce=true) const;
      vector<uint> getAdjacentFacets(uint hull_member,bool ignore_vertical=true,bool ignore_artificial=true) const;
    ...
    private:
      ...
      bool createHull(const vector<xvector<double> >& vcoords,bool has_stoich_coords=false,bool half_hull=false,bool add_artificial_unaries=false);
      bool createHull(const vector<ChullPoint>& vpoints,bool half_hull=false,bool add_artificial_unaries=false);
      bool createHull(const vector<ChullPoint>& vpoints,const vector<string>& velements,bool half_hull=false,bool add_artificial_unaries=false);

      //methods associated with points
      bool entryValid(const aflowlib::_aflowlib_entry& entry) const;
      bool entryValid(const aflowlib::_aflowlib_entry& entry,string& reason) const;
      bool entryValid(const aflowlib::_aflowlib_entry& entry,string& reason,char& LOGGER_TYPE) const;
      ...
      void loadPoints(const vector<xvector<double> >& vcoords,bool has_stoich_coords=false,bool half_hull=false,bool add_artificial_unaries=false);
      void loadPoints(const vector<ChullPoint>& vpoints,bool half_hull=false,bool add_artificial_unaries=false);
      void loadPoints(const vector<ChullPoint>& vpoints,const vector<string>& velements,bool half_hull=false,bool add_artificial_unaries=false);
      ...
      void addRelevantUnaries(uint i_nary,uint i_alloy);
      void addRelevantUnaries(xvector<int>& elements_present);
      void addLowerDimensionHullMembers(uint i_nary_max);
      void addHullPoint(uint i_point);
      void addHullPoint(uint i_point,xvector<int>& elements_present);
      void prepareHullPoints(uint i_nary,uint i_alloy);
      void prepareHullPoints();
      ...
      void storeHullData();
      void thermodynamicPostprocessing(uint i_nary,uint i_alloy);
      void calculate();
      void cleanHull(); //clean state of hull
      
      //writer functions
      string prettyPrintCompound(const ChullPoint& point,bool reduce=true,bool exclude1=true,char mode=_latex_) const;
      string prettyPrintCompound(const aflowlib::_aflowlib_entry& entry,bool reduce=true,bool exclude1=true,char mode=_latex_) const;
      string prettyPrintCompound(const vector<string>& vspecies,const vector<double>& vcomposition,bool reduce=true,bool exclude1=true,char mode=_latex_) const;
      string prettyPrintCompound(const vector<string>& vspecies,const xvector<double>& vcomposition,bool reduce=true,bool exclude1=true,char mode=_latex_) const;
      string prettyPrintPrototype(const ChullPoint& point, bool double_back_slash) const;
      string prettyPrintPrototype(const aflowlib::_aflowlib_entry& entry, bool double_back_slash) const;
      string fixStringLatex(const string& input, bool double_back_slash,bool symmetry_string) const;
      string addHeaderStringLaTeX(char function_mode,bool points_color_gradient=DEFAULT_CHULL_LATEX_COLOR_GRADIENT) const;
      string addPointContentLaTeX(const ChullPoint& point,bool zero_end_point=true,bool zero_dist_2_hull=false) const;
      ...
      string addPlainTextTable(const vector<string>& headers,const vector<vector<string> >& ventries,const vector<uint>& sizes) const;
      string addJSONTable(const vector<string>& headers,const vector<vector<string> >& ventries) const;
