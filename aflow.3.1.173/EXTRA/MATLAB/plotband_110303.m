...
klabel_rhl1=['\Gamma-X-M-\Gamma-X1-M-W-X-X1-W-\Gamma-L-K-\Gamma-R-K-U-L-R-U-X-L-M-U-X1-R-U1-L-N-K-U1-X1-N-M-U1-N-W-U-\Gamma-N-R-M-K-X-R-W-L-X1-K-W_{U1|U}-N-X-U1-\Gamma'];
klabel_rhl2=['\Gamma-R-M-\Gamma-S-M-N-\Gamma-Q-R-N-S-Q-M-H-\Gamma-P-R-H-S-P_{M|N}-Q-H-N-P-H'];
...
switch Norb
 case 1
   if(strcmp(DOSscalemode,'log'))
     semilogx((Sup-Sdown)*scaleDOS,EDOS(:,1)-maxEv,'k:','linewidth',1.2);
   end
 ...
 case 2
   if(strcmp(DOSscalemode,'log'))
     semilogx((Sup-Sdown)*scaleDOS,EDOS(:,1)-maxEv,'k:','linewidth',1.2);
     hold on;semilogx((Pup-Pdown)*scaleDOS,EDOS(:,1)-maxEv,'b-.','linewidth',0.8);
   end
   if(strcmp(DOSscalemode,'normal'))
     plot((Sup-Sdown)*scaleDOS,EDOS(:,1)-maxEv,'k:','linewidth',1.2);
 ...
 case 3
   if(strcmp(DOSscalemode,'log'))
     semilogx((Sup-Sdown)*scaleDOS,EDOS(:,1)-maxEv,'k:','linewidth',1.2);
     hold on;semilogx((Pup-Pdown)*scaleDOS,EDOS(:,1)-maxEv,'b-.','linewidth',0.8);
     hold on;semilogx((Dup-Ddown)*scaleDOS,EDOS(:,1)-maxEv,'r--','linewidth',0.8);
   end
   if(strcmp(DOSscalemode,'normal'))
     plot((Sup-Sdown)*scaleDOS,EDOS(:,1)-maxEv,'k:','linewidth',1.2);
     hold on;plot((Pup-Pdown)*scaleDOS,EDOS(:,1)-maxEv,'b-.','linewidth',0.8);
 ...
 case 4
   if(strcmp(DOSscalemode,'log'))
     ...
     hold on;semilogx((Pup-Pdown)*scaleDOS,EDOS(:,1)-maxEv,'b-.','linewidth',0.8);
     hold on;semilogx((Dup-Ddown)*scaleDOS,EDOS(:,1)-maxEv,'r--','linewidth',0.8);
     hold on;semilogx((Fup-Fdown)*scaleDOS,EDOS(:,1)-maxEv,'g-','linewidth',0.8);
   end
   if(strcmp(DOSscalemode,'normal'))
     plot((Sup-Sdown)*scaleDOS,EDOS(:,1)-maxEv,'k:','linewidth',1.2);
     hold on;plot((Pup-Pdown)*scaleDOS,EDOS(:,1)-maxEv,'b-.','linewidth',0.8);
