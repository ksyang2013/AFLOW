/******************************************************************
* (C) 1999-2007 - Stefano Curtarolo                               *
* send bugs to stefano@curtarolo.com                              *
******************************************************************/
...
//  printf("number: %i \n",argc);
  found=0;
  if (argc<=3) {
    printf("subst version %s\n",REL);
    printf("Usage: subst string1 string2 inputfile1 [inputfile2 ...]\n");
    printf("       replace string1 with string2. \n");
    printf("\n");
