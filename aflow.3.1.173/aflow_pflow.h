...
static const uint _AFLOW_LIB_MAX_ = 6;  //LIB7 does not exist yet, modify accordingly
...
namespace pflow {
  ...
  void getCombination(vector<string>& velements, vector<string>& combination, vector<vector<string> >& combinations, uint offset, uint nary);
  vector<vector<string> > elementalCombinations(vector<string>& velements, uint nary);
  ////////////////////////////////////////////////////////////////////////////////
  //easy way to think about it:  do compounds belong to the hull?
  bool compoundsBelong(vector<string>& velements, string input, ostream& oss=cout, bool sort_input=false);
  bool compoundsBelong(vector<string>& velements, string input, ofstream& FileMESSAGE, ostream& oss=cout, bool sort_input=false);
  bool compoundsBelong(vector<string>& velements, vector<string> elements, bool sort_elements=false);
  ////////////////////////////////////////////////////////////////////////////////
  // loads xstructures
  ...
  vector<string> stringElements2VectorElements(string input, ostream& oss=cout, bool clean=true);
  vector<string> stringElements2VectorElements(string input, ofstream& FileMESSAGE, ostream& oss=cout, bool clean=true);
  ////////////////////////////////////////////////////////////////////////////////
  // functions for making input alphabetic
  // PdMn -> MnPd, does it by CAPITAL letters
  string makeAlphabeticString(string input, ostream& oss=cout);
  string makeAlphabeticString(string input, ofstream& FileMESSAGE, ostream& oss=cout);
  vector<string> makeAlphabeticVector(string input, ostream& oss=cout);
  vector<string> makeAlphabeticVector(string input, ofstream& FileMESSAGE, ostream& oss=cout);
  ////////////////////////////////////////////////////////////////////////////////
  // sets default flags
...
namespace pflow {
  ...
  void PrintCIF(ostream& oss,const xstructure&,int=1);
  ...
  void PrintData(const xstructure& str,xstructure& str_sym,xstructure& str_sp,xstructure& str_sc, ostream& oss,string smode, double tolerance, bool no_scan, const string& format="txt",bool already_calculated=false); //CO171027
  ...
  void PrintData(const xstructure& str,ostream& oss,string smode,double tolerance, bool no_scan, const string& format="txt");
  ...
  bool PrintSGData(xstructure& str_sg, double& tolerance, ostream& oss, bool no_scan, bool standalone=true, const string& format="txt",bool already_calculated=false); //DX 2/26/18 - added & to tolerance
}
