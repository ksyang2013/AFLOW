...
std::string _XHOST::command(const string& command) {
  ...
  for(uint i=0;i<vcmd.size();i++) if(vcmd.at(i)==command) return vcmd.at(i); // found before.. only == otherwise cat gets confused with bzcat
...
bool _XHOST::is_command(const string& command) {
  string _command=command;
#ifdef _MACOSX_
  if(command=="beep") return TRUE;
#endif
  for(uint i=0;i<vcmd.size();i++) if(aurostd::substring2bool(vcmd.at(i),_command)) return TRUE; // found before..
  if(aurostd::IsCommandAvailableModify(_command)) return TRUE;
...
_kflags::_kflags() {
  ...
  KBIN_FROZSL_FILE_NAME                            = _AFLOW_FROZSL_INPUT_FILE_;
...
_vflags::_vflags() {
  ...
  KBIN_VASP_RUN.addscheme("");                                   // RUN
  //  REPEAT
  KBIN_VASP_REPEAT.clear();                                      // REPEAT
  KBIN_VASP_REPEAT.addscheme("");                                // REPEAT
  ...
  KBIN_VASP_FORCE_OPTION_RELAX_MODE.addscheme(DEFAULT_VASP_FORCE_OPTION_RELAX_MODE_SCHEME); // RELAX_MODE forces/energy    
  
  //  RELAX_TYPE
  KBIN_VASP_FORCE_OPTION_RELAX_TYPE.clear();                     // RELAX_TYPE geometry   
  KBIN_VASP_FORCE_OPTION_RELAX_TYPE.addscheme("");               // RELAX_TYPE geometry    

  KBIN_VASP_FORCE_OPTION_PREC.clear();                           // PREC
  KBIN_VASP_FORCE_OPTION_PREC.addscheme(DEFAULT_VASP_FORCE_OPTION_PREC_SCHEME); // PREC
  KBIN_VASP_FORCE_OPTION_ALGO.clear();                           // ALGO
  KBIN_VASP_FORCE_OPTION_ALGO.addscheme(DEFAULT_VASP_FORCE_OPTION_ALGO_SCHEME); // ALGO
  KBIN_VASP_FORCE_OPTION_METAGGA.clear();                        // METAGGA
  KBIN_VASP_FORCE_OPTION_METAGGA.addscheme(DEFAULT_VASP_FORCE_OPTION_METAGGA_SCHEME); // METAGGA
  KBIN_VASP_FORCE_OPTION_IVDW.clear();                           // IVDW
  KBIN_VASP_FORCE_OPTION_IVDW.addscheme(DEFAULT_VASP_FORCE_OPTION_IVDW_SCHEME); // IVDW
  KBIN_VASP_FORCE_OPTION_ABMIX.clear();                          // ABMIX
  KBIN_VASP_FORCE_OPTION_ABMIX.addscheme(DEFAULT_VASP_FORCE_OPTION_ABMIX_SCHEME); // ABMIX
  KBIN_VASP_FORCE_OPTION_AUTO_PSEUDOPOTENTIALS.clear();          // AUTO_PSEUDOPOTENTIALS
  KBIN_VASP_FORCE_OPTION_AUTO_PSEUDOPOTENTIALS.addscheme(DEFAULT_VASP_PSEUDOPOTENTIAL_TYPE); // AUTO_PSEUDOPOTENTIALS
  
  // ENMAX_MULTIPLY
  KBIN_VASP_FORCE_OPTION_ENMAX_MULTIPLY_EQUAL.clear();
  //  KBIN_VASP_FORCE_OPTION_ENMAX_MULTIPLY_EQUAL.addscheme("1.4");

  // NBANDS
  KBIN_VASP_FORCE_OPTION_NBANDS_AUTO_isentry                     = FALSE;
  // NBANDS
  KBIN_VASP_FORCE_OPTION_NBANDS_EQUAL.clear();
  //  KBIN_VASP_FORCE_OPTION_NBANDS_EQUAL.addscheme("0");
  // POTIM
  KBIN_VASP_FORCE_OPTION_POTIM_EQUAL.clear();
  KBIN_VASP_FORCE_OPTION_POTIM_EQUAL.addscheme(aurostd::utype2string(DEFAULT_VASP_PREC_POTIM));
  // PSTRESS
  KBIN_VASP_FORCE_OPTION_PSTRESS_EQUAL.clear();
  // KBIN_VASP_FORCE_OPTION_PSTRESS_EQUAL.addscheme("0.0");
  // EDIFFG
  KBIN_VASP_FORCE_OPTION_EDIFFG_EQUAL.clear();
  KBIN_VASP_FORCE_OPTION_EDIFFG_EQUAL.addscheme(aurostd::utype2string(DEFAULT_VASP_PREC_EDIFFG));
  // RWIGS
  ...
  KBIN_VASP_FORCE_OPTION_TYPE.addscheme(DEFAULT_VASP_FORCE_OPTION_TYPE_SCHEME); // TYPE
  ...
  KBIN_VASP_FORCE_OPTION_VOLUME.addscheme("");                   // RUN
  ...
  KBIN_VASP_KPOINTS_KMODE.addscheme("0");                        // KMODE
  KBIN_VASP_KPOINTS_KPPRA.clear();                               // KPPRA
  KBIN_VASP_KPOINTS_KPPRA.addscheme("100");                      // KPPRA
  KBIN_VASP_KPOINTS_KSCHEME.clear();                             // KSCHEME
  KBIN_VASP_KPOINTS_KSCHEME.addscheme(DEFAULT_KSCHEME);//"Monkhorst-Pack"; // KSCHEME
  KBIN_VASP_KPOINTS_KSHIFT.clear();                              // KSCHEME
  KBIN_VASP_KPOINTS_KSHIFT.addscheme("0 0 0");                   // DEFAULT FIX
  // STATIC
  KBIN_VASP_KPOINTS_STATIC_KMODE.clear();                        // KMODE
  KBIN_VASP_KPOINTS_STATIC_KMODE.addscheme("0");                 // KMODE
  KBIN_VASP_KPOINTS_STATIC_KPPRA.clear();                        // KPPRA
  KBIN_VASP_KPOINTS_STATIC_KPPRA.addscheme("1");                 // KPPRA
  KBIN_VASP_KPOINTS_STATIC_KSCHEME.clear();                      // KSCHEME
  KBIN_VASP_KPOINTS_STATIC_KSCHEME.addscheme(DEFAULT_STATIC_KSCHEME);//"Monkhorst-Pack"); // KSCHEME
  KBIN_VASP_KPOINTS_STATIC_KSHIFT.clear();                       // KSCHEME
  KBIN_VASP_KPOINTS_STATIC_KSHIFT.addscheme("0 0 0"); // DEFAULT FIX
  // PHONONS
  KBIN_VASP_KPOINTS_PHONONS_KPPRA.clear();                       // KPPRA
  KBIN_VASP_KPOINTS_PHONONS_KPPRA.addscheme("1");                // KPPRA
  KBIN_VASP_KPOINTS_PHONONS_KSCHEME.clear();                     // KSCHEME
  KBIN_VASP_KPOINTS_PHONONS_KSCHEME.addscheme(DEFAULT_PHONONS_KSCHEME);  //"Gamma");           // KSCHEME
  ...
  KBIN_VASP_KPOINTS_BANDS_LATTICE.addscheme(DEFAULT_BANDS_LATTICE);             // some default
  ...
  KBIN_VASP_POSCAR_FILE_VOLUME.addscheme("");                    // RUN
...
_xvasp::_xvasp() {
  ...
  AVASP_potential="potpaw_PBE";                   // DEFAULT VALUES
  ...
  AVASP_flag_TYPE.scheme=                                "DEFAULT";
...
_aimsflags::_aimsflags() {
  ...
  KBIN_AIMS_FORCE_OPTION_NOTUNE.addscheme("");
  KBIN_AIMS_RUN.clear();
  KBIN_AIMS_RUN.addscheme("");
  KBIN_AIMS_GEOM_MODE.clear();
  KBIN_AIMS_GEOM_MODE.addscheme("");
  KBIN_AIMS_GEOM_FILE.clear();
  KBIN_AIMS_GEOM_FILE.addscheme("");
  KBIN_AIMS_GEOM_FILE_VOLUME.clear();
  KBIN_AIMS_GEOM_FILE_VOLUME.addscheme("");
  KBIN_AIMS_FORCE_OPTION_VOLUME.clear();
  KBIN_AIMS_FORCE_OPTION_VOLUME.addscheme("");
  KBIN_AIMS_FORCE_OPTION_CONVERT_UNIT_CELL.clear();
  KBIN_AIMS_FORCE_OPTION_CONVERT_UNIT_CELL.addscheme("");
  KBIN_AIMS_CONTROL_MODE.clear();
  KBIN_AIMS_CONTROL_MODE.addscheme("");
  KBIN_AIMS_CONTROL_FILE.clear();
  KBIN_AIMS_CONTROL_FILE.addscheme("");
