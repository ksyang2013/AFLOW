...
class Supercell {
 private:
  Logger& _logger;
  xstructure _pcStructure;
  xstructure _pcStructure_original;  //CO
  xstructure _pcStructure_light;     //CO, does not include HEAVY symmetry stuff
  //deque<_atom> _pcStructure_atoms_original; //CO
 ...
 public:
  ...
  const xstructure& getStructure();
  xstructure getStructureLight();
  const xstructure& getPrimitiveStructure();
  xstructure getPrimitiveStructureLight();
...
class IPhononCalculator {
 public:
  ...
  virtual const xstructure& getPrimitiveCellStructure() = 0;
...
class PhononCalculator : virtual public IPhononCalculator {
 ...
 protected:
  ...
  void createAIMSOUTPUT(const _xaims&);
  void createAFLOWIN(const _xvasp&);
 ...
 public:
  ...
  const xstructure& getPrimitiveCellStructure();
...
class eos_calculate : public PhononCalculator {
 ...
 private:
  ...
  void writeGPOUTPUT(const _xinput& xinput, const bool _isGP);
  void createGPAIMSOUTPUT(const _xaims& xaims_input);
  void createGPAFLOWIN(const _xvasp& xvasp_input, const bool _isGP);
...
class PathBuilder {
 ...
 public:
  ...
  void takeAflowElectronicPath(const string&, const xstructure&, const xstructure&);
...
class PhononDispersionCalculator {
 ...
 public:
  ...
  void clear();
  void initPath(const string&, int);
...
// ***************************************************************************
namespace apl {
//Functions in this calss are used to calculate full equation of states//
