...
void RunPhonons_APL(_xinput& xinput,
  ...
  aurostd::xoption USER_BTE_OPTION; USER_BTE_OPTION.scheme = "RTA"; string USER_BTE = "RTA";
  ...
  aurostd::xoption USER_TDISTORTION_MAGNITUDE_OPTION; USER_TDISTORTION_MAGNITUDE_OPTION.scheme = "0.015"; double USER_TDISTORTION_MAGNITUDE = 0.015;
  aurostd::xoption USER_THERMALGRID_OPTION; USER_THERMALGRID_OPTION.scheme = "8x8x8"; string USER_THERMALGRID = "8x8x8";
  aurostd::xoption USER_CUTOFF_DISTANCE_OPTION; USER_CUTOFF_DISTANCE_OPTION.scheme = "-300"; double USER_CUTOFF_DISTANCE = -300; 
  aurostd::xoption USER_NANO_SIZE_OPTION; USER_NANO_SIZE_OPTION.scheme = "13000"; double USER_NANO_SIZE = 13000;
  aurostd::xoption USER_EPS_SUM_OPTION; USER_EPS_SUM_OPTION.scheme = "1E-5"; double USER_EPS_SUM = 1E-5;
  aurostd::xoption USER_CUTOFF_SHELL_OPTION; USER_CUTOFF_SHELL_OPTION.scheme = "0"; int USER_CUTOFF_SHELL = 0;
  aurostd::xoption USER_TCT_OPTION; USER_TCT_OPTION.scheme = "200:700:100"; double USER_TCT_TSTART = 200; double USER_TCT_TEND = 700; double USER_TCT_TSTEP = 100;
  // END JJPR
  ...
  aurostd::xoption GP_VOL_DISTORTION_OPTION; GP_VOL_DISTORTION_OPTION.scheme = "0.03"; double GP_VOL_DISTORTION = 0.03;
  aurostd::xoption USER_PROJECTION_DIR_OPTION; USER_PROJECTION_DIR_OPTION.scheme = "1:1:1"; vector<double> directions(3, 0); directions[0] = 1; directions[1] = 1; directions[2] = 1;   // 3 Miller indices
  aurostd::xoption CUTOFF_FREQ_OPTION; CUTOFF_FREQ_OPTION.scheme="1e-5"; double CUTOFF_FREQ = 1e-5;  //in amu
  aurostd::xoption EOS_VOLRANGE_DIST_OPTION; EOS_VOLRANGE_DIST_OPTION.scheme = "-2:4:0.5"; double EOS_VOL_START = -2; double EOS_VOL_END = 4; double EOS_VOL_DISTORTION = 0.5;
  ...
  aurostd::xoption EOS_KPOINTS_MODE_OPTION; EOS_KPOINTS_MODE_OPTION.scheme = "8000:10000:20:50000"; string EOS_KPPRA = "8000"; string EOS_STATIC_KPPRA = "10000"; string EOS_BANDS_GRID = "20"; string NEDOS = "50000"; //PINKU make int?
  aurostd::xoption FITTING_TYPE_OPTION; FITTING_TYPE_OPTION.scheme = "BM1"; string FITTING_TYPE = "BM1";
  //PINKU QUASI-HARMONIC END
  
  // User's control about general phonon engine
  aurostd::xoption USER_ENGINE_OPTION; USER_ENGINE_OPTION.scheme = "DM"; string USER_ENGINE = "DM";
  ...
  aurostd::xoption USER_DISTORTION_MAGNITUDE_OPTION; USER_DISTORTION_MAGNITUDE_OPTION.scheme = "0.015"; double USER_DISTORTION_MAGNITUDE = 0.015;
  ...
  aurostd::xoption USER_FREQFORMAT_OPTION; USER_FREQFORMAT_OPTION.scheme="THZ | ALLOW_NEGATIVE"; string USER_FREQFORMAT = "THZ | ALLOW_NEGATIVE";
  ...
  aurostd::xoption USER_MAXSHELL_OPTION; USER_MAXSHELL_OPTION.scheme = "-1"; int USER_MAXSHELL = -1;  //CO set by OPTION
  aurostd::xoption USER_MINSHELL_OPTION; USER_MINSHELL_OPTION.scheme = "6"; int USER_MINSHELL = 6;  //CO set by OPTION
  aurostd::xoption USER_MINATOMS_OPTION; USER_MINATOMS_OPTION.scheme = "100"; int USER_MINATOMS = 100;  //CO set by OPTION
  aurostd::xoption USER_SUPERCELL_OPTION; USER_SUPERCELL_OPTION.scheme = ""; string USER_SUPERCELL = "";

  // User's control about calculation of dispersion curves
  aurostd::xoption USER_DC_INITPATH_OPTION; USER_DC_INITPATH_OPTION.scheme = ""; string USER_DC_INITPATH = "";  //CO set by OPTION
  aurostd::xoption USER_DC_DCINITSG_OPTION; USER_DC_DCINITSG_OPTION.scheme = ""; int USER_DC_DCINITSG = 1;
  aurostd::xoption USER_DC_OWNPATH_OPTION; USER_DC_OWNPATH_OPTION.scheme = ""; string USER_DC_OWNPATH = ""; //CO set by OPTION
  aurostd::xoption USER_DC_NPOINTS_OPTION; USER_DC_NPOINTS_OPTION.scheme = "100"; int USER_DC_NPOINTS = 100;

  // User's control about phonon DOS
  aurostd::xoption USER_DOS_MESH_OPTION; USER_DOS_MESH_OPTION.scheme = "21x21x21"; string USER_DOS_MESH = "21x21x21";
  aurostd::xoption USER_DOS_NPOINTS_OPTION; USER_DOS_NPOINTS_OPTION.scheme = "2000"; int USER_DOS_NPOINTS = 2000;
  aurostd::xoption USER_DOS_METHOD_OPTION; USER_DOS_METHOD_OPTION.scheme = "LT"; string USER_DOS_METHOD = "LT";
  aurostd::xoption USER_DOS_SMEAR_OPTION; USER_DOS_SMEAR_OPTION.scheme = "0.0"; double USER_DOS_SMEAR = 0.0;

  // User's control of thermodynamic properties calculation
  aurostd::xoption USER_TPT_OPTION; USER_TPT_OPTION.scheme="0:2000:10"; double USER_TP_TSTART = 0; double USER_TP_TEND = 2000;  double USER_TP_TSTEP = 10;
  ...
  try {
    ...
    // KAPPA, e.g. KAPPA = y
      ...
      USER_CUTOFF_DISTANCE_OPTION.options2entry(AflowIn, string( _ASTROPT_ + "CUT_RAD=" + "|" + _ASTROPT_APL_OLD_ + "CUT_RAD="), USER_CUTOFF_DISTANCE_OPTION.option, USER_CUTOFF_DISTANCE_OPTION.scheme); //CO 170601
      ...
      USER_EPS_SUM_OPTION.options2entry(AflowIn, string( _ASTROPT_ + "SUMRULE=" + "|" + _ASTROPT_APL_OLD_ + "SUMRULE="), USER_EPS_SUM_OPTION.option, USER_EPS_SUM_OPTION.scheme); //CO 170601
      ...
      USER_CUTOFF_SHELL_OPTION.options2entry(AflowIn, string( _ASTROPT_ + "CUT_SHELL=" + "|" + _ASTROPT_APL_OLD_ + "CUT_SHELL="), USER_CUTOFF_SHELL_OPTION.option, USER_CUTOFF_SHELL_OPTION.scheme); //CO 170601
      ...
      USER_TDISTORTION_MAGNITUDE_OPTION.options2entry(AflowIn, string(_ASTROPT_ + "TDMAG=" + "|" +_ASTROPT_APL_OLD_ + "TDMAG=" + "|" + _ASTROPT_ + "TDISMAG=" + "|" +_ASTROPT_APL_OLD_ + "TDISMAG="), USER_TDISTORTION_MAGNITUDE_OPTION.option, USER_TDISTORTION_MAGNITUDE_OPTION.scheme);  //CO 170621 - TDISMAG legacy
      ...
      CALCULATE_ISOTOPE_OPTION.options2entry(AflowIn, string(_ASTROPT_ + "ISOTOPE=" + "|" +_ASTROPT_APL_OLD_ + "ISOTOPE="), CALCULATE_ISOTOPE_OPTION.option, CALCULATE_ISOTOPE_OPTION.scheme); //CO 170601
      ...
      CALCULATE_BOUNDARY_OPTION.options2entry(AflowIn, string(_ASTROPT_ + "BOUNDARY=" + "|" +_ASTROPT_APL_OLD_ + "BOUNDARY="), CALCULATE_BOUNDARY_OPTION.option, CALCULATE_BOUNDARY_OPTION.scheme); //CO 170601
      ...
      CALCULATE_CUMULATIVEK_OPTION.options2entry(AflowIn, string(_ASTROPT_ + "CUMULATIVEK=" + "|" +_ASTROPT_APL_OLD_ + "CUMULATIVEK="), CALCULATE_CUMULATIVEK_OPTION.option, CALCULATE_CUMULATIVEK_OPTION.scheme); //CO 170601
      ...
      if(CALCULATE_BOUNDARY_OPTION.option){
        USER_NANO_SIZE_OPTION.options2entry(AflowIn, string( _ASTROPT_ + "NANO_SIZE=" + "|" + _ASTROPT_APL_OLD_ + "NANO_SIZE="), USER_NANO_SIZE_OPTION.option, USER_NANO_SIZE_OPTION.scheme); //CO 170601
      ...
      // BTE, e.g. BTE = RTA
      USER_BTE_OPTION.options2entry(AflowIn, string(_ASTROPT_ + "BTE=" + "|" +_ASTROPT_APL_OLD_ + "BTE="), USER_BTE_OPTION.option, USER_BTE_OPTION.scheme); //CO 170601
      ...
      USER_THERMALGRID_OPTION.options2entry(AflowIn, string( _ASTROPT_ + "THERMALGRID=" + "|" + _ASTROPT_APL_OLD_ + "THERMALGRID="), USER_THERMALGRID_OPTION.option, USER_THERMALGRID_OPTION.scheme); //CO 170601
      ...
      // no default here
      USER_TCT_OPTION.options2entry(AflowIn, string( _ASTROPT_ + "TCT=" + "|" + _ASTROPT_APL_OLD_ + "TCT="), USER_TCT_OPTION.option, USER_TCT_OPTION.scheme); //CO 170601
      tokens.clear();
    ...
    if(!CALCULATE_KAPPA_OPTION.option){
      if(kflags.KBIN_PHONONS_CALCULATION_QHA){
        ...
        CUTOFF_FREQ_OPTION.options2entry(AflowIn, string( _ASTROPT_ + "CUTOFF_FREQ=" + "|" + _ASTROPT_APL_OLD_ + "CUTOFF_FREQ="), CUTOFF_FREQ_OPTION.option, CUTOFF_FREQ_OPTION.scheme); //CO 170601
        ...
        CALCULATE_DISPLACEMENTS_OPTION.options2entry(AflowIn, string(_ASTROPT_ + "DISPLACEMENTS=" + "|" + _ASTROPT_APL_OLD_ + "DISPLACEMENTS="), CALCULATE_DISPLACEMENTS_OPTION.option, CALCULATE_DISPLACEMENTS_OPTION.scheme); //CO 170601
        ...
        USER_PROJECTION_DIR_OPTION.options2entry(AflowIn, string( _ASTROPT_ + "PROJECTION_DIR=" + "|" + _ASTROPT_APL_OLD_ + "PROJECTION_DIR="), USER_PROJECTION_DIR_OPTION.option, USER_PROJECTION_DIR_OPTION.scheme); //CO 170601
        tokens.clear();
        ...
        CALCULATE_GRUNEISEN_SUBDIRECTORIES_OPTION.options2entry(AflowIn, string(_ASTROPT_ + "GRUNEISENSD=" + "|" + _ASTROPT_APL_OLD_ + "GRUNEISENSD="), CALCULATE_GRUNEISEN_SUBDIRECTORIES_OPTION.option, CALCULATE_GRUNEISEN_SUBDIRECTORIES_OPTION.scheme); //CO 170601
        ...
        GP_VOL_DISTORTION_OPTION.options2entry(AflowIn, string( _ASTROPT_ + "GP_VOL_DISTORTION_PERCENTAGE=" + "|" + _ASTROPT_APL_OLD_ + "GP_VOL_DISTORTION_PERCENTAGE="), GP_VOL_DISTORTION_OPTION.option, GP_VOL_DISTORTION_OPTION.scheme); //CO 170601
        ...
        if (CALCULATE_GRUNEISEN_SUBDIRECTORIES_OPTION.option) {
          CALCULATE_EOS_SUBDIRECTORIES_OPTION.options2entry(AflowIn, string(_ASTROPT_ + "EOSSD=" + "|" + _ASTROPT_APL_OLD_ + "EOSSD="), CALCULATE_EOS_SUBDIRECTORIES_OPTION.option, CALCULATE_EOS_SUBDIRECTORIES_OPTION.scheme); //CO 170601
        ...
        CALCULATE_EOS_OPTION.options2entry(AflowIn, string(_ASTROPT_ + "EOS=" + "|" + _ASTROPT_APL_OLD_ + "EOS="), CALCULATE_EOS_OPTION.option, CALCULATE_EOS_OPTION.scheme); //CO 170601
        ...
        if (CALCULATE_EOS_OPTION.option) {
          EOS_VOLRANGE_DIST_OPTION.options2entry(AflowIn, string( _ASTROPT_ + "EOS_VOLRANGE_DIST=" + "|" + _ASTROPT_APL_OLD_ + "EOS_VOLRANGE_DIST="), EOS_VOLRANGE_DIST_OPTION.option, EOS_VOLRANGE_DIST_OPTION.scheme); //CO 170601
          tokens.clear();
          ...
          EOS_KPOINTS_MODE_OPTION.options2entry(AflowIn, string( _ASTROPT_ + "EOS_KPOINTS_MODE=" + "|" + _ASTROPT_APL_OLD_ + "EOS_KPOINTS_MODE="), EOS_KPOINTS_MODE_OPTION.option, EOS_KPOINTS_MODE_OPTION.scheme); //CO 170601
          tokens.clear();
          ...
          FITTING_TYPE_OPTION.options2entry(AflowIn, string( _ASTROPT_ + "FITTING_TYPE=" + "|" + _ASTROPT_APL_OLD_ + "FITTING_TYPE="), FITTING_TYPE_OPTION.option, FITTING_TYPE_OPTION.scheme); //CO 170601
    ...
    USER_HIBERNATE_OPTION.options2entry(AflowIn, string( _ASTROPT_APL_ + "HIBERNATE=" + "|" + _ASTROPT_QHA_ + "HIBERNATE=" + "|" + _ASTROPT_AAPL_ + "HIBERNATE=" + "|" + _ASTROPT_APL_OLD_ + "HIBERNATE="), USER_HIBERNATE_OPTION.option, USER_HIBERNATE_OPTION.scheme); //CO 170601
    ...
    USER_FREQFORMAT_OPTION.options2entry(AflowIn, string( _ASTROPT_APL_ + "FREQFORMAT=" + "|" + _ASTROPT_QHA_ + "FREQFORMAT=" + "|" + _ASTROPT_AAPL_ + "FREQFORMAT=" + "|" + _ASTROPT_APL_OLD_ + "FREQFORMAT="), USER_FREQFORMAT_OPTION.option, USER_FREQFORMAT_OPTION.scheme); //CO 170601
    ...
    USER_ENGINE_OPTION.options2entry(AflowIn, string( _ASTROPT_APL_ + "ENGINE=" + "|" + _ASTROPT_QHA_ + "ENGINE=" + "|" + _ASTROPT_AAPL_ + "ENGINE=" + "|" + _ASTROPT_APL_OLD_ + "ENGINE="), USER_ENGINE_OPTION.option, USER_ENGINE_OPTION.scheme); //CO 170601
    ...
    if (USER_ENGINE == string("DM")) {
      ...
      USER_DISTORTIONS_PLUS_MINUS_OPTION.options2entry(AflowIn, string( _ASTROPT_APL_ + "DPM=" + "|" + _ASTROPT_QHA_ + "DPM=" + "|" + _ASTROPT_AAPL_ + "DPM=" + "|" + _ASTROPT_APL_OLD_ + "DPM="), USER_DISTORTIONS_PLUS_MINUS_OPTION.option, USER_DISTORTIONS_PLUS_MINUS_OPTION.scheme); //CO 170601
      ...
      USER_DISTORTIONS_XYZ_ONLY_OPTION.options2entry(AflowIn, string( _ASTROPT_APL_ + "DXYZONLY=" + "|" + _ASTROPT_QHA_ + "DXYZONLY=" + "|" + _ASTROPT_AAPL_ + "DXYZONLY=" + "|" + _ASTROPT_APL_OLD_ + "DXYZONLY="), USER_DISTORTIONS_XYZ_ONLY_OPTION.option, USER_DISTORTIONS_XYZ_ONLY_OPTION.scheme); //CO 170601
      ...
      USER_ZEROSTATE_OPTION.options2entry(AflowIn, string( _ASTROPT_APL_ + "ZEROSTATE=" + "|" + _ASTROPT_QHA_ + "ZEROSTATE=" + "|" + _ASTROPT_AAPL_ + "ZEROSTATE=" + "|" + _ASTROPT_APL_OLD_ + "ZEROSTATE="), USER_ZEROSTATE_OPTION.option, USER_ZEROSTATE_OPTION.scheme); //CO 170601
    ...
    if (USER_ENGINE == string("LR") || USER_ENGINE == string("DM")) {
      CALCULATE_POLAR_CORRECTIONS_OPTION.options2entry(AflowIn, string( _ASTROPT_APL_ + "POLAR=" + "|" + _ASTROPT_QHA_ + "POLAR=" + "|" + _ASTROPT_AAPL_ + "POLAR=" + "|" + _ASTROPT_APL_OLD_ + "POLAR="), CALCULATE_POLAR_CORRECTIONS_OPTION.option, CALCULATE_POLAR_CORRECTIONS_OPTION.scheme); //CO 170601
        ...
        if (!vaspVersion.empty()) {
          ...
          if ((vaspVersion[0] - '0') < 5) { //cool way of getting ascii value:  https://stackoverflow.com/questions/36310181/char-subtraction-in-c
            ...
            if(_WITHIN_DUKE_){
              ...
              throw apl::APLRuntimeError("The LR engine needs VASP6 or higher version.");
            }
    ...
    USER_WANTS_RELAX_OPTION.options2entry(AflowIn, string( _ASTROPT_APL_ + "RELAX=" + "|" + _ASTROPT_QHA_ + "RELAX=" + "|" + _ASTROPT_AAPL_ + "RELAX=" + "|" + _ASTROPT_APL_OLD_ + "RELAX="), USER_WANTS_RELAX_OPTION.option, USER_WANTS_RELAX_OPTION.scheme); //CO 170601
    ...
    USER_SUPERCELL_OPTION.options2entry(AflowIn, string( _ASTROPT_APL_ + "SUPERCELL=" + "|" + _ASTROPT_QHA_ + "SUPERCELL=" + "|" + _ASTROPT_AAPL_ + "SUPERCELL=" + "|" + _ASTROPT_APL_OLD_ + "SUPERCELL="), USER_SUPERCELL_OPTION.option, USER_SUPERCELL_OPTION.scheme); //CO 170601
    ...
    if(!found_supercell){
      USER_MINATOMS_OPTION.options2entry(AflowIn, string( _ASTROPT_APL_ + "MINATOMS=" + "|" + _ASTROPT_QHA_ + "MINATOMS=" + "|" + _ASTROPT_AAPL_ + "MINATOMS=" + "|" + _ASTROPT_APL_OLD_ + "MINATOMS="), USER_MINATOMS_OPTION.option, USER_MINATOMS_OPTION.scheme); //CO 170601
      USER_MINATOMS = USER_MINATOMS_OPTION.content_int;
      if(USER_MINATOMS_OPTION.isentry){
        logger << (USER_MINATOMS_OPTION.isentry ? "Setting" : "DEFAULT") << " " << _ASTROPT_ << "MINATOMS=" << USER_MINATOMS << "." << apl::endl;
    ...
    if(!found_supercell){
      USER_MAXSHELL_OPTION.options2entry(AflowIn, string( _ASTROPT_APL_ + "MAXSHELL=" + "|" + _ASTROPT_QHA_ + "MAXSHELL=" + "|" + _ASTROPT_AAPL_ + "MAXSHELL=" + "|" + _ASTROPT_APL_OLD_ + "MAXSHELL="), USER_MAXSHELL_OPTION.option, USER_MAXSHELL_OPTION.scheme); //CO 170601
    ...
    if(!found_supercell){
      USER_MINSHELL_OPTION.options2entry(AflowIn, string( _ASTROPT_APL_ + "MINSHELL=" + "|" + _ASTROPT_QHA_ + "MINSHELL=" + "|" + _ASTROPT_AAPL_ + "MINSHELL=" + "|" + _ASTROPT_APL_OLD_ + "MINSHELL="), USER_MINSHELL_OPTION.option, USER_MINSHELL_OPTION.scheme); //CO 170601
    ...
    // Get the users KSCHEME which will be included into calculation, get from AFLOW machinery
      ...
      if (xflags.vflags.KBIN_VASP_FORCE_OPTION_KPOINTS_PHONONS_PARITY.isscheme("EVEN")) {logger << "Overriding with " << _ASTROPT_ << "KPOINTS=EVEN" << "." << apl::endl;}
      if (xflags.vflags.KBIN_VASP_FORCE_OPTION_KPOINTS_PHONONS_PARITY.isscheme("ODD")) {logger << "Overriding with " << _ASTROPT_ << "KPOINTS=ODD" << "." << apl::endl;}
    }

    // ADDITIONAL OPTIONS ------------------------------------------------

    // DC. e.g., DC = yes
    CALCULATE_PHONON_DISPERSIONS_OPTION.options2entry(AflowIn, string( _ASTROPT_APL_ + "DC=" + "|" + _ASTROPT_QHA_ + "DC=" + "|" + _ASTROPT_AAPL_ + "DC=" + "|" + _ASTROPT_APL_OLD_ + "DC="), CALCULATE_PHONON_DISPERSIONS_OPTION.option, CALCULATE_PHONON_DISPERSIONS_OPTION.scheme); //CO 170601
    ...
    if (CALCULATE_PHONON_DISPERSIONS_OPTION.option) {
      // DCINITPATH, e.g., DCINITPATH = RHL
      // DCINITSSG,  e.g., DCINITSG = 166
      USER_DC_INITPATH_OPTION.options2entry(AflowIn, string( _ASTROPT_APL_ + "DCINITPATH=" + "|" + _ASTROPT_QHA_ + "DCINITPATH=" + "|" + _ASTROPT_AAPL_ + "DCINITPATH=" + "|" + _ASTROPT_APL_OLD_ + "DCINITPATH="), USER_DC_INITPATH_OPTION.option, USER_DC_INITPATH_OPTION.scheme); //CO 170601
      USER_DC_DCINITSG_OPTION.options2entry(AflowIn, string( _ASTROPT_APL_ + "DCINITSG=" + "|" + _ASTROPT_QHA_ + "DCINITSG=" + "|" + _ASTROPT_AAPL_ + "DCINITSG=" + "|" + _ASTROPT_APL_OLD_ + "DCINITSG="), USER_DC_DCINITSG_OPTION.option, USER_DC_DCINITSG_OPTION.scheme); //CO 170601
      if(USER_DC_INITPATH_OPTION.isentry) {
        USER_DC_INITPATH = USER_DC_INITPATH_OPTION.content_string;
        logger << "Setting " << _ASTROPT_ << "DCINITPATH=" << USER_DC_INITPATH << " (via DCINITPATH)." << apl::endl;
      }else if(USER_DC_DCINITSG_OPTION.isentry){
        USER_DC_DCINITSG = USER_DC_DCINITSG_OPTION.content_int;
        USER_DC_INITPATH = LATTICE::SpaceGroup2LatticeVariation(USER_DC_DCINITSG, xinput.getXStr()); //xvasp.str);
        logger << "Setting " << _ASTROPT_ << "DCINITPATH=" << USER_DC_INITPATH << " (via DCINITSG)." << apl::endl;
      }  //corey

      // DCUSERPATH, e.g., DCUSERPATH = G-X|X-U|K-G|G-L
      USER_DC_OWNPATH_OPTION.options2entry(AflowIn, string( _ASTROPT_APL_ + "DCUSERPATH=" + "|" + _ASTROPT_QHA_ + "DCUSERPATH=" + "|" + _ASTROPT_AAPL_ + "DCUSERPATH=" + "|" + _ASTROPT_APL_OLD_ + "DCUSERPATH="), USER_DC_OWNPATH_OPTION.option, USER_DC_OWNPATH_OPTION.scheme); //CO 170601
      USER_DC_OWNPATH = USER_DC_OWNPATH_OPTION.content_string;
      if(USER_DC_OWNPATH_OPTION.isentry){
        logger << "Setting " << _ASTROPT_ << "DCUSERPATH=" << USER_DC_OWNPATH << "." << apl::endl;
        logger << "User's q-point path will be calculated along [" << USER_DC_OWNPATH << "]." << apl::endl;
      } else {USER_DC_OWNPATH.clear();}

      // DCPOINTS, e.g., DCPOINTS = 100
      USER_DC_NPOINTS_OPTION.options2entry(AflowIn, string( _ASTROPT_APL_ + "DCPOINTS=" + "|" + _ASTROPT_QHA_ + "DCPOINTS=" + "|" + _ASTROPT_AAPL_ + "DCPOINTS=" + "|" + _ASTROPT_APL_OLD_ + "DCPOINTS="), USER_DC_NPOINTS_OPTION.option, USER_DC_NPOINTS_OPTION.scheme); //CO 170601
    ...
    // DOS, e.g., DOS = yes
    CALCULATE_PHONON_DOS_OPTION.options2entry(AflowIn, string( _ASTROPT_APL_ + "DOS=" + "|" + _ASTROPT_QHA_ + "DOS=" + "|" + _ASTROPT_AAPL_ + "DOS=" + "|" + _ASTROPT_APL_OLD_ + "DOS="), CALCULATE_PHONON_DOS_OPTION.option, CALCULATE_PHONON_DOS_OPTION.scheme); //CO 170601
    ...
    if (CALCULATE_PHONON_DOS_OPTION.option){
      ...
      USER_DOS_MESH_OPTION.options2entry(AflowIn, string( _ASTROPT_APL_ + "DOSMESH=" + "|" + _ASTROPT_QHA_ + "DOSMESH=" + "|" + _ASTROPT_AAPL_ + "DOSMESH=" + "|" + _ASTROPT_APL_OLD_ + "DOSMESH="), USER_DOS_MESH_OPTION.option, USER_DOS_MESH_OPTION.scheme); //CO 170601
      ...
      USER_DOS_NPOINTS_OPTION.options2entry(AflowIn, string( _ASTROPT_APL_ + "DOSPOINTS=" + "|" + _ASTROPT_QHA_ + "DOSPOINTS=" + "|" + _ASTROPT_AAPL_ + "DOSPOINTS=" + "|" + _ASTROPT_APL_OLD_ + "DOSPOINTS="), USER_DOS_NPOINTS_OPTION.option, USER_DOS_NPOINTS_OPTION.scheme); //CO 170601
      ...
      USER_DOS_METHOD_OPTION.options2entry(AflowIn, string( _ASTROPT_APL_ + "DOSMETHOD=" + "|" + _ASTROPT_QHA_ + "DOSMETHOD=" + "|" + _ASTROPT_AAPL_ + "DOSMETHOD=" + "|" + _ASTROPT_APL_OLD_ + "DOSMETHOD="), USER_DOS_METHOD_OPTION.option, USER_DOS_METHOD_OPTION.scheme); //CO 170601
      ...
      USER_DOS_SMEAR_OPTION.options2entry(AflowIn, string( _ASTROPT_APL_ + "DOSSMEAR=" + "|" + _ASTROPT_QHA_ + "DOSSMEAR=" + "|" + _ASTROPT_AAPL_ + "DOSSMEAR=" + "|" + _ASTROPT_APL_OLD_ + "DOSSMEAR="), USER_DOS_SMEAR_OPTION.option, USER_DOS_SMEAR_OPTION.scheme); //CO 170601
    ...
    // TP, e.g., TP = yes
    CALCULATE_THERMODYNAMIC_PROPERTIES_OPTION.options2entry(AflowIn, string( _ASTROPT_APL_ + "TP=" + "|" + _ASTROPT_QHA_ + "TP=" + "|" + _ASTROPT_AAPL_ + "TP=" + "|" + _ASTROPT_APL_OLD_ + "TP="), CALCULATE_THERMODYNAMIC_PROPERTIES_OPTION.option, CALCULATE_THERMODYNAMIC_PROPERTIES_OPTION.scheme); //CO 170601
    ...
    if (CALCULATE_THERMODYNAMIC_PROPERTIES_OPTION.option){
      USER_TPT_OPTION.options2entry(AflowIn, string( _ASTROPT_APL_ + "TPT=" + "|" + _ASTROPT_QHA_ + "TPT=" + "|" + _ASTROPT_AAPL_ + "TPT=" + "|" + _ASTROPT_APL_OLD_ + "TPT="), USER_TPT_OPTION.option, USER_TPT_OPTION.scheme); //CO 170601
      tokens.clear();
  ...
  try {
    ...
    if (CALCULATE_KAPPA_OPTION.option) {
      supercell.calcRl();
      apl::StrPairs _strPair(supercell.getStructure(), supercell.getPrimitiveStructure(), supercell._pc2scMap, supercell._sc2pcMap, USER_CUTOFF_SHELL, USER_CUTOFF_DISTANCE, logger);
      strPair = _strPair;  //CO, copies everything
      USER_CUTOFF_DISTANCE = strPair.getShellDist(supercell.getStructure(), USER_CUTOFF_SHELL, USER_CUTOFF_DISTANCE);
      strPair.build(supercell.getPrimitiveStructure(), supercell.getStructure());
      strPair.Triplets();
    }
    // ******  END JJPR ******
    ...
    if (CALCULATE_GRUNEISEN_SUBDIRECTORIES_OPTION.option) {
      ...
      if (store.check_GP()) {  //Check directory is Gruneisen ?
        ...
        store.createMPmesh(aurostd::string2utype<int>(tokens.at(0)),
                           aurostd::string2utype<int>(tokens.at(1)),
                           aurostd::string2utype<int>(tokens.at(2)),
                           phcalc->getPrimitiveCellStructure());

        apl::PhononDispersionCalculator pdisc(*phcalc, logger);
        // Init path according to the aflow's definition for elec. struc.
        pdisc.initPath(USER_DC_INITPATH, USER_DC_NPOINTS);
        // Does user want his own path?
        if (!USER_DC_OWNPATH.empty()) pdisc.setPath(USER_DC_OWNPATH);
      ...
      if (CALCULATE_EOS_SUBDIRECTORIES_OPTION.option) {  //Check directory is EOS ?
        ...
        apl::MonkhorstPackMesh qmesh(
            ...
            aurostd::string2utype<int>(tokens.at(1)),
            aurostd::string2utype<int>(tokens.at(2)),
            phcalc->getPrimitiveCellStructure(), logger);
