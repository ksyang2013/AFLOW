...
namespace aurostd {
  ...
  //CO - END
  bool BunzipFile(string file);
  bool BzipFile(string file);
  bool GzipFile(const string& _file); //CO
  bool ZipFile(const string& _file); //CO
  bool FileExist(const string& FileName);
  bool EFileExist(const string& FileName);
  bool EFileExist(const string& FileName,string &FileNameOut);
  bool CompressedFileExist(const string& FileName, string& FileNameOut); //CO
  bool CompressedFileExist(const string& FileName); //CO
  ...
  // about writing files
  bool string2file(const string& StringOUTPUT,string FileNameOUTPUT,string="");
  bool stringstream2file(const stringstream& StringstreamOUTPUT,string FileNameOUTPUT,string="");
  bool string2gzfile(const string& StringOUTPUT,string FileNameOUTPUT,string="");
  bool stringstream2gzfile(const stringstream& StringstreamOUTPUT,string FileNameOUTPUT,string="");
  bool string2bz2file(const string& StringOUTPUT,string FileNameOUTPUT,string="");
  bool stringstream2bz2file(const stringstream& StringstreamOUTPUT,string FileNameOUTPUT,string="");
  // file2string
...
namespace aurostd {
  // [OBSOLTE] string xmatDouble2String(const xmatrix<double>& xmat_in, bool roff=false);
...
namespace aurostd {
  // [OBSOLTE] vector<string> vecDouble2vecString(const vector<double>& vin, bool roff=false);
  ...
  // [OBSOLTE] vector<string> xvecDouble2vecString(const xvector<double>& vin, bool roff=false);
  ...
  // [OBSOLTE] deque<string> deqDouble2deqString(const deque<double>& vin, bool roff=false);
...
namespace aurostd {
  ...
  bool bin2base64(std::string& b_file, std::string& b64String); //converts binary file to base64 string
  bool base642bin(const std::string& b64String, std::string& b_file); //converts base64 string to binary file
