...
#define RTPI              (sqrt(PI))
#define C_VACUUM          2.99792E+8         // m/s
...
#define PLANKSCONSTANT_h  6.62618E-34        // J*s
#define KBOLTZ            1.3806504E-23      // J/K
#define KBOLTZEV          8.617343E-5        // eV/K
#define E_ELECTRON        1.60219E-19        // C
...
namespace aurostd {
  // namespace aurostd
  template<class utype> bool _isfloat(utype) __xprototype;
...
//--------------------------------------------------------------- isequal
namespace aurostd {
  template<class utype> bool identical(const utype& a,const utype& b,const utype& _tol_) __xprototype;
  template<class utype> bool identical(const utype& a,const utype& b) __xprototype;
  template<class utype> bool isdifferent(const utype& a,const utype& b,const utype& _tol_) __xprototype;
  template<class utype> bool isdifferent(const utype& a,const utype& b) __xprototype;
  template<class utype> bool isequal(const utype& a,const utype& b,const utype& _tol_) __xprototype;
  template<class utype> bool isequal(const utype& a,const utype& b) __xprototype;
}
