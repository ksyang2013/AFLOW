...
namespace KBIN{
  ...
  _aimsflags AIMS_Get_AIMSflags_from_AflowIN(string& AflowIn,ofstream& FileMESSAGE,_aflags& aflags,_kflags& kflags) {
    ...
    if((aurostd::substring2bool(AflowIn,"[AIMS_RUN_GENERATE]") || aurostd::substring2bool(AflowIn,"[AIMS_RUN]GENERATE")) || aflags.KBIN_GEN_AIMS_FROM_AFLOWIN) 
      aimsflags.KBIN_AIMS_RUN.addscheme("GENERATE");

    if(aurostd::substring2bool(AflowIn,"[AIMS_CONTROL_FILE]")) aimsflags.KBIN_AIMS_CONTROL_FILE.addscheme("KEYWORD");
    if(aurostd::substring2bool(AflowIn,"[AIMS_CONTROL_FILE]SYSTEM_AUTO",TRUE)) aimsflags.KBIN_AIMS_CONTROL_FILE.addscheme("SYSTEM_AUTO");
    if(aurostd::substring2bool(AflowIn,"[AIMS_CONTROL_FILE]FILE=",TRUE)) aimsflags.KBIN_AIMS_CONTROL_FILE.addscheme("FILE");
    if(aurostd::substring2bool(AflowIn,"[AIMS_CONTROL_FILE]COMMAND=",TRUE)) aimsflags.KBIN_AIMS_CONTROL_FILE.addscheme("COMMAND");
    if(aurostd::substring2bool(AflowIn,"[AIMS_CONTROL_MODE_EXPLICIT]")) aimsflags.KBIN_AIMS_CONTROL_MODE.addscheme("EXPLICIT");
    if(aurostd::substring2bool(AflowIn,"[AIMS_CONTROL_MODE_EXPLICIT]START") && aurostd::substring2bool(AflowIn,"[AIMS_CONTROL_MODE_EXPLICIT]STOP")) aimsflags.KBIN_AIMS_CONTROL_MODE.addscheme("EXPLICIT_START_STOP");
    if(aurostd::substring2bool(AflowIn,"[AIMS_CONTROL_MODE_IMPLICIT]")) aimsflags.KBIN_AIMS_CONTROL_MODE.addscheme("IMPLICIT");
    if(aurostd::substring2bool(AflowIn,"[AIMS_CONTROL_MODE_EXTERNAL]")) aimsflags.KBIN_AIMS_CONTROL_MODE.addscheme("EXTERNAL");
    
    if(aurostd::substring2bool(AflowIn,"[AIMS_GEOM_FILE]"))  aimsflags.KBIN_AIMS_GEOM_FILE.addscheme("KEYWORD");
    if(aurostd::substring2bool(AflowIn,"[AIMS_GEOM_MODE_EXPLICIT]")) aimsflags.KBIN_AIMS_GEOM_MODE.addscheme("EXPLICIT");
    if(aurostd::substring2bool(AflowIn,"[AIMS_GEOM_MODE_EXPLICIT]START") &&  aurostd::substring2bool(AflowIn,"[AIMS_GEOM_MODE_EXPLICIT]STOP")) aimsflags.KBIN_AIMS_GEOM_MODE.addscheme("EXPLICIT_START_STOP");
    if((aurostd::substring2bool(AflowIn,"[AIMS_GEOM_MODE_EXPLICIT]START.") && aurostd::substring2bool(AflowIn,"[AIMS_GEOM_MODE_EXPLICIT]STOP."))) aimsflags.KBIN_AIMS_GEOM_MODE.addscheme("EXPLICIT_START_STOP_POINT");

    if(aimsflags.KBIN_AIMS_GEOM_MODE.isscheme("EXPLICIT_START_STOP_POINT") && !kflags.KBIN_FROZSL) {  // NO FROZSL
      if(LDEBUG) cerr << "DEBUG: aimsflags.KBIN_AIMS_GEOM_MODE.isscheme(\"EXPLICIT_START_STOP_POINT\")=" << aimsflags.KBIN_AIMS_GEOM_MODE.isscheme("EXPLICIT_START_STOP_POINT") << endl;
      ...
      if(aimsflags.KBIN_AIMS_GEOM_MODE.isscheme("EXPLICIT_START_STOP_POINT")) input_file.str(AflowIn);

      aimsflags.KBIN_AIMS_GEOM_MODE.addscheme("EXPLICIT_START_STOP_POINT");
    ...
    // the rest for GEOM
    if(aurostd::substring2bool(AflowIn,"[AIMS_GEOM_MODE_IMPLICIT]")) aimsflags.KBIN_AIMS_GEOM_MODE.addscheme("IMPLICIT");
    if(aurostd::substring2bool(AflowIn,"[AIMS_GEOM_FILE]PROTOTYPE=",TRUE)) aimsflags.KBIN_AIMS_GEOM_FILE.addscheme("PROTOTYPE");
    if(aurostd::substring2bool(AflowIn,"[AIMS_GEOM_MODE_EXTERNAL]")) aimsflags.KBIN_AIMS_GEOM_MODE.addscheme("EXTERNAL");
    if(aurostd::substring2bool(AflowIn,"[AIMS_GEOM_FILE]FILE=",TRUE)) aimsflags.KBIN_AIMS_GEOM_FILE.addscheme("FILE");
    if(aurostd::substring2bool(AflowIn,"[AIMS_GEOM_FILE]COMMAND=",TRUE)) aimsflags.KBIN_AIMS_GEOM_FILE.addscheme("COMMAND");

    // VOLUMES
    aimsflags.KBIN_AIMS_GEOM_FILE_VOLUME.clear();
    if(aurostd::substring2bool(AflowIn,"[AIMS_GEOM_FILE]VOLUME=",TRUE)) aimsflags.KBIN_AIMS_GEOM_FILE_VOLUME.addscheme("EQUAL_EQUAL");
    if(aurostd::substring2bool(AflowIn,"[AIMS_GEOM_FILE]VOLUME+=",TRUE)) aimsflags.KBIN_AIMS_GEOM_FILE_VOLUME.addscheme("PLUS_EQUAL");
    // [OBSOLETE] if(aurostd::substring2bool(AflowIn,"[AIMS_GEOM_FILE]VOLUME-=",TRUE)) aimsflags.KBIN_AIMS_GEOM_FILE_VOLUME.addscheme("MINUS_EQUAL");
    if(aurostd::substring2bool(AflowIn,"[AIMS_GEOM_FILE]VOLUME*=",TRUE)) aimsflags.KBIN_AIMS_GEOM_FILE_VOLUME.addscheme("MULTIPLY_EQUAL");
    // [OBSOLETE] if(aurostd::substring2bool(AflowIn,"[AIMS_GEOM_FILE]VOLUME/=",TRUE)) aimsflags.KBIN_AIMS_GEOM_FILE_VOLUME.addscheme("DIVIDE_EQUAL");
    if(aimsflags.KBIN_AIMS_GEOM_FILE_VOLUME.scheme!="") aimsflags.KBIN_AIMS_GEOM_FILE_VOLUME.isentry=TRUE;
    ...
    // // PRIORITIES
    if(aimsflags.KBIN_AIMS_FORCE_OPTION_CONVERT_UNIT_CELL.isscheme("STANDARD_PRIMITIVE") || aimsflags.KBIN_AIMS_FORCE_OPTION_CONVERT_UNIT_CELL.isscheme("STANDARD_CONVENTIONAL")) {
    ...
    if(LDEBUG) cerr << "KBIN::AIMS_Get_aimsflags_from_AflowIN: aimsflags.KBIN_AIMS_FORCE_OPTION_CONVERT_UNIT_CELL.isscheme(\"STANDARD_PRIMITIVE\")=" <<  aimsflags.KBIN_AIMS_FORCE_OPTION_CONVERT_UNIT_CELL.isscheme("STANDARD_PRIMITIVE") << endl;
    if(LDEBUG) cerr << "KBIN::AIMS_Get_aimsflags_from_AflowIN: aimsflags.KBIN_AIMS_FORCE_OPTION_CONVERT_UNIT_CELL.isscheme(\"STANDARD_CONVENTIONAL\")=" <<  aimsflags.KBIN_AIMS_FORCE_OPTION_CONVERT_UNIT_CELL.isscheme("STANDARD_CONVENTIONAL") << endl;
    if(LDEBUG) cerr << "KBIN::AIMS_Get_aimsflags_from_AflowIN: aimsflags.KBIN_AIMS_FORCE_OPTION_CONVERT_UNIT_CELL.isscheme(\"NIGGLI\")=" <<  aimsflags.KBIN_AIMS_FORCE_OPTION_CONVERT_UNIT_CELL.isscheme("NIGGLI") << endl;
    if(LDEBUG) cerr << "KBIN::AIMS_Get_aimsflags_from_AflowIN: aimsflags.KBIN_AIMS_FORCE_OPTION_CONVERT_UNIT_CELL.isscheme(\"MINKOWSKI\")=" <<  aimsflags.KBIN_AIMS_FORCE_OPTION_CONVERT_UNIT_CELL.isscheme("MINKOWSKI") << endl;
    if(LDEBUG) cerr << "KBIN::AIMS_Get_aimsflags_from_AflowIN: aimsflags.KBIN_AIMS_FORCE_OPTION_CONVERT_UNIT_CELL.isscheme(\"INCELL\")=" <<  aimsflags.KBIN_AIMS_FORCE_OPTION_CONVERT_UNIT_CELL.isscheme("INCELL") << endl;
    if(LDEBUG) cerr << "KBIN::AIMS_Get_aimsflags_from_AflowIN: aimsflags.KBIN_AIMS_FORCE_OPTION_CONVERT_UNIT_CELL.isscheme(\"COMPACT\")=" <<  aimsflags.KBIN_AIMS_FORCE_OPTION_CONVERT_UNIT_CELL.isscheme("COMPACT") << endl;
    if(LDEBUG) cerr << "KBIN::AIMS_Get_aimsflags_from_AflowIN: aimsflags.KBIN_AIMS_FORCE_OPTION_CONVERT_UNIT_CELL.isscheme(\"WIGNERSEITZ\")=" <<  aimsflags.KBIN_AIMS_FORCE_OPTION_CONVERT_UNIT_CELL.isscheme("WIGNERSEITZ") << endl;
    if(LDEBUG) cerr << "KBIN::AIMS_Get_aimsflags_from_AflowIN: aimsflags.KBIN_AIMS_FORCE_OPTION_CONVERT_UNIT_CELL.isscheme(\"CARTESIAN\")=" <<  aimsflags.KBIN_AIMS_FORCE_OPTION_CONVERT_UNIT_CELL.isscheme("CARTESIAN") << endl;
    if(LDEBUG) cerr << "KBIN::AIMS_Get_aimsflags_from_AflowIN: aimsflags.KBIN_AIMS_FORCE_OPTION_CONVERT_UNIT_CELL.isscheme(\"FRACTIONAL\")=" <<  aimsflags.KBIN_AIMS_FORCE_OPTION_CONVERT_UNIT_CELL.isscheme("FRACTIONAL") << endl;
    if(LDEBUG) cerr << "KBIN::AIMS_Get_aimsflags_from_AflowIN: aimsflags.KBIN_AIMS_FORCE_OPTION_CONVERT_UNIT_CELL.isscheme(\"DIRECT\")=" <<  aimsflags.KBIN_AIMS_FORCE_OPTION_CONVERT_UNIT_CELL.isscheme("DIRECT") << endl;
    if(LDEBUG) cerr << "KBIN::AIMS_Get_aimsflags_from_AflowIN: aimsflags.KBIN_AIMS_FORCE_OPTION_CONVERT_UNIT_CELL.isscheme(\"PRESERVE\")=" <<  aimsflags.KBIN_AIMS_FORCE_OPTION_CONVERT_UNIT_CELL.isscheme("PRESERVE") << endl;
    ...
    // [OBSOLETE]  if(aurostd::substring2bool(AflowIn,_STROPT_+"VOLUME=",TRUE)) aimsflags.KBIN_AIMS_FORCE_OPTION_VOLUME.addscheme("EQUAL_EQUAL");
    // [OBSOLETE]  if(aurostd::substring2bool(AflowIn,_STROPT_+"VOLUME+=",TRUE)) aimsflags.KBIN_AIMS_FORCE_OPTION_VOLUME.addscheme("PLUS_EQUAL");
    // [OBSOLETE]  if(aurostd::substring2bool(AflowIn,_STROPT_+"VOLUME-=",TRUE)) aimsflags.KBIN_AIMS_FORCE_OPTION_VOLUME.addscheme("MINUS_EQUAL");
    // [OBSOLETE]  if(aurostd::substring2bool(AflowIn,_STROPT_+"VOLUME*=",TRUE)) aimsflags.KBIN_AIMS_FORCE_OPTION_VOLUME.addscheme("MULTIPLY_EQUAL");
    // [OBSOLETE]  if(aurostd::substring2bool(AflowIn,_STROPT_+"VOLUME/=",TRUE)) aimsflags.KBIN_AIMS_FORCE_OPTION_VOLUME.addscheme("DIVIDE_EQUAL");
    ...
    if(aimsflags.KBIN_AIMS_FORCE_OPTION_VOLUME.scheme!="") aimsflags.KBIN_AIMS_FORCE_OPTION_VOLUME.isentry=TRUE;
...
namespace KBIN{
  bool AIMS_Directory(ofstream &FileMESSAGE,_aflags &aflags,_kflags &kflags) {
    ...
    if(aimsflags.KBIN_AIMS_RUN.isscheme("GENERATE")) aus << "00000  MESSAGE KBIN::AIMS_Directory Running RUN_GENERATE" << Message(aflags,"user,host,time") << endl;
    ...
    for(uint ixinput=0;ixinput<ntasks;ixinput++) {  // LOOP ixinput
      ...
      if(Krun && aimsflags.KBIN_AIMS_GEOM_MODE.isscheme("EXPLICIT_START_STOP_POINT")) {
        if(FileExist(xaims.Directory)) {
          ...
          if(Krun && FileExist(xaims.Directory+"/"+_AFLOWLOCK_)) Krun=FALSE;    // to fight against NFS cache
          if(Krun && FileExist(xaims.Directory+"/"+_AFLOWLOCK_+".gz")) Krun=FALSE;     // to fight against NFS cache
          if(Krun && FileExist(xaims.Directory+"/"+_AFLOWLOCK_+".bz2")) Krun=FALSE;     // to fight against NFS cache
          if(Krun && FileExist(xaims.Directory+"/LLOCK")) Krun=FALSE;     // to fight against NFS cache
          if(Krun && FileExist(xaims.Directory+"/LLOCK.gz")) Krun=FALSE;     // to fight against NFS cache
          if(Krun && FileExist(xaims.Directory+"/LLOCK.bz2")) Krun=FALSE;     // to fight against NFS cache
          if(Krun) {
      ...
      if(Krun) {
        ...
        // AIMS HOW TO RUN ??
        // GENERATE ONLY -------------------------------------------------------------
        if(aimsflags.KBIN_AIMS_RUN.isscheme("GENERATE")) {
