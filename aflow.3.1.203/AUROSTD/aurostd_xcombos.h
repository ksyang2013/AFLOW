...
namespace aurostd {
  class xcombos {
    private:
      ...
      vector<int> m_p;
      int m_x,m_y;
      bool repeat;  // Set to true if repetitions are allowed
      bool sequence;  // Set to true if sequence matters
      
      void incrementPermutation();
      void incrementCombinations();
      void initializeCombinationsP();
      void setCombinationsIncrementParameters();
      void getNextRepeatCombination(); // ME 180510
      void initialize();
    public:
      ...
      xcombos(int choice_count,int choose_count, bool rpt=FALSE, bool seq=FALSE); //combinations, m choose n, m=choice_count, n=choose_count
      ...
      void reset(int choice_count,int choose_count, bool rpt=FALSE, bool seq=FALSE); //reset with combinations
