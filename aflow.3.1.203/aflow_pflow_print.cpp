...
namespace pflow {
    ...
    if(format=="txt"){
      ...
      oss << " Space group label (Hall)                     = " << GetSpaceGroupHall(str_sg.space_group_ITC, str_sg.directory) << endl; //DX 20180526 - add directory
    ...
    // FORMAT = JSON
      ...
      string sg_Hall = GetSpaceGroupHall(str_sg.space_group_ITC, str_sg.directory); //DX 20180526 - add directory
      if(sg_Hall.size()){
