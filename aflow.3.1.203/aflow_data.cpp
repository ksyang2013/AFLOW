...
int main(int _argc,char **_argv) {
  ...
  for(int i=1;i<_argc;i++) {
	...
	if(argvi=="Library_ICSD" || argvi=="aflowlib_lib1" || argvi=="aflowlib_lib2" || argvi=="aflowlib_lib3" || argvi=="aflowlib_lib4" || argvi=="aflowlib_lib5" || argvi=="aflowlib_lib6" || argvi=="aflowlib_lib7" || argvi=="aflowlib_lib8" || argvi=="aflowlib_lib9" || argvi=="aflowlib_icsd" ) { string FileLibrary;
	  string *pstr;
