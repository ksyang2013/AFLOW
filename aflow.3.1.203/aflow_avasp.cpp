...
bool AVASP_populateXVASP(const _aflags& aflags,const _kflags& kflags,const _vflags& vflags,_xvasp& xvasp){
  ...
  if(LDEBUG){cerr << "xvasp.AVASP_EXTRA_INCAR=" << endl << xvasp.AVASP_EXTRA_INCAR.str() << endl;}
  if(LDEBUG){cerr << "xvasp.AVASP_KSCHEME=" << xvasp.AVASP_KSCHEME << endl;}
  if(LDEBUG){cerr << "xvasp.AVASP_LDAU_PARAMETERS_STRING=" << xvasp.AVASP_LDAU_PARAMETERS_STRING << endl;}
  if(LDEBUG){cerr << "xvasp.AVASP_STATIC_KSCHEME=" << xvasp.AVASP_STATIC_KSCHEME << endl;}
  if(LDEBUG){cerr << "xvasp.AVASP_aflowin_only_if_missing=" << xvasp.AVASP_aflowin_only_if_missing << endl;}
  if(LDEBUG){cerr << "xvasp.AVASP_alpha_fix=" << xvasp.AVASP_alpha_fix << endl;}
  if(LDEBUG){cerr << "xvasp.AVASP_dirbase=" << xvasp.AVASP_dirbase << endl;}
  if(LDEBUG){cerr << "xvasp.AVASP_directory_from_library_=" << xvasp.AVASP_directory_from_library_ << endl;}
  if(LDEBUG){cerr << "xvasp.AVASP_flag_ABMIX_scheme=" << xvasp.AVASP_flag_ABMIX_scheme << endl;}
  if(LDEBUG){cerr << "xvasp.AVASP_flag_ALGO_scheme=" << xvasp.AVASP_flag_ALGO_scheme << endl;}
  if(LDEBUG){cerr << "xvasp.AVASP_flag_GENERATE=" << xvasp.AVASP_flag_GENERATE << endl;}
  if(LDEBUG){cerr << "xvasp.AVASP_flag_MPI=" << xvasp.AVASP_flag_MPI << endl;}
  if(LDEBUG){cerr << "xvasp.AVASP_flag_PRECISION_scheme=" << xvasp.AVASP_flag_PRECISION_scheme << endl;}
  if(LDEBUG){cerr << "xvasp.AVASP_flag_RUN_RELAX=" << xvasp.AVASP_flag_RUN_RELAX << endl;}
  if(LDEBUG){cerr << "xvasp.AVASP_flag_RUN_RELAX_STATIC=" << xvasp.AVASP_flag_RUN_RELAX_STATIC << endl;}
  if(LDEBUG){cerr << "xvasp.AVASP_flag_RUN_RELAX_STATIC_BANDS=" << xvasp.AVASP_flag_RUN_RELAX_STATIC_BANDS << endl;}
  if(LDEBUG){cerr << "xvasp.AVASP_flag_RUN_STATIC=" << xvasp.AVASP_flag_RUN_STATIC << endl;}
  if(LDEBUG){cerr << "xvasp.AVASP_flag_RUN_STATIC_BANDS=" << xvasp.AVASP_flag_RUN_STATIC_BANDS << endl;}
  if(LDEBUG){cerr << "xvasp.AVASP_flag_TYPE.xscheme=" << xvasp.AVASP_flag_TYPE.xscheme << endl;}
  if(LDEBUG){cerr << "xvasp.AVASP_label=" << xvasp.AVASP_label << endl;}
  if(LDEBUG){cerr << "xvasp.AVASP_libbase=" << xvasp.AVASP_libbase << endl;}
  if(LDEBUG){cerr << "xvasp.AVASP_parameters=" << xvasp.AVASP_parameters << endl;}
  if(LDEBUG){cerr << "xvasp.AVASP_path_BANDS=" << xvasp.AVASP_path_BANDS << endl;}
  if(LDEBUG){cerr << "xvasp.AVASP_potential=" << xvasp.AVASP_potential << endl;}
  if(LDEBUG){cerr << "xvasp.AVASP_prototype_from_library_=" << xvasp.AVASP_prototype_from_library_ << endl;}
  if(LDEBUG){cerr << "xvasp.AVASP_prototype_mode=" << xvasp.AVASP_prototype_mode << endl;}
  if(LDEBUG){cerr << "xvasp.AVASP_value_BANDS_GRID=" << xvasp.AVASP_value_BANDS_GRID << endl;}
  if(LDEBUG){cerr << "xvasp.AVASP_value_KPPRA=" << xvasp.AVASP_value_KPPRA << endl;}
  if(LDEBUG){cerr << "xvasp.AVASP_value_KPPRA_STATIC=" << xvasp.AVASP_value_KPPRA_STATIC << endl;}
  if(LDEBUG){cerr << "xvasp.AVASP_value_NSW=" << xvasp.AVASP_value_NSW << endl;}
  if(LDEBUG){cerr << "xvasp.AVASP_volume_in=" << xvasp.AVASP_volume_in << endl;}
  if(LDEBUG){cerr << "xvasp.Directory=" << xvasp.Directory << endl;}
  if(LDEBUG){cerr << "xvasp.POTCAR_TYPE_DATE_PRINT_flag=" << xvasp.POTCAR_TYPE_DATE_PRINT_flag << endl;}
  if(LDEBUG){cerr << "xvasp.aopts.flag(\"AFLOWIN_FLAG::ABINIT\")=" << xvasp.aopts.flag("AFLOWIN_FLAG::ABINIT") << endl;}
  if(LDEBUG){cerr << "xvasp.aopts.flag(\"AFLOWIN_FLAG::AIMS\")=" << xvasp.aopts.flag("AFLOWIN_FLAG::AIMS") << endl;}
  if(LDEBUG){cerr << "xvasp.aopts.flag(\"AFLOWIN_FLAG::ALGORITHM\")=" << xvasp.aopts.flag("AFLOWIN_FLAG::ALGORITHM") << endl;}
  if(LDEBUG){cerr << "xvasp.aopts.flag(\"AFLOWIN_FLAG::APL_SUPERCELL\")=" << xvasp.aopts.flag("AFLOWIN_FLAG::APL_SUPERCELL") << endl;}
  if(LDEBUG){cerr << "xvasp.aopts.flag(\"AFLOWIN_FLAG::BANDS_GRID\")=" << xvasp.aopts.flag("AFLOWIN_FLAG::BANDS_GRID") << endl;}
  if(LDEBUG){cerr << "xvasp.aopts.flag(\"AFLOWIN_FLAG::CONVERT_UNIT_CELL\")=" << xvasp.aopts.flag("AFLOWIN_FLAG::CONVERT_UNIT_CELL") << endl;}
  if(LDEBUG){cerr << "xvasp.aopts.flag(\"AFLOWIN_FLAG::EDIFFG\")=" << xvasp.aopts.flag("AFLOWIN_FLAG::EDIFFG") << endl;}
  if(LDEBUG){cerr << "xvasp.aopts.flag(\"AFLOWIN_FLAG::ENMAX_MULTIPLY\")=" << xvasp.aopts.flag("AFLOWIN_FLAG::ENMAX_MULTIPLY") << endl;}
  if(LDEBUG){cerr << "xvasp.aopts.flag(\"AFLOWIN_FLAG::ENMAX_MULTYPLY\")=" << xvasp.aopts.flag("AFLOWIN_FLAG::ENMAX_MULTYPLY") << endl;}
  if(LDEBUG){cerr << "xvasp.aopts.flag(\"AFLOWIN_FLAG::IVDW\")=" << xvasp.aopts.flag("AFLOWIN_FLAG::IVDW") << endl;}
  if(LDEBUG){cerr << "xvasp.aopts.flag(\"AFLOWIN_FLAG::KPPRA\")=" << xvasp.aopts.flag("AFLOWIN_FLAG::KPPRA") << endl;}
  if(LDEBUG){cerr << "xvasp.aopts.flag(\"AFLOWIN_FLAG::KPPRA_STATIC\")=" << xvasp.aopts.flag("AFLOWIN_FLAG::KPPRA_STATIC") << endl;}
  if(LDEBUG){cerr << "xvasp.aopts.flag(\"AFLOWIN_FLAG::METAGGA\")=" << xvasp.aopts.flag("AFLOWIN_FLAG::METAGGA") << endl;}
  if(LDEBUG){cerr << "xvasp.aopts.flag(\"AFLOWIN_FLAG::MODULE\")=" << xvasp.aopts.flag("AFLOWIN_FLAG::MODULE") << endl;}
  if(LDEBUG){cerr << "xvasp.aopts.flag(\"AFLOWIN_FLAG::NBANDS\")=" << xvasp.aopts.flag("AFLOWIN_FLAG::NBANDS") << endl;}
  if(LDEBUG){cerr << "xvasp.aopts.flag(\"AFLOWIN_FLAG::NO_VOLUME_ADJUSTMENT\")=" << xvasp.aopts.flag("AFLOWIN_FLAG::NO_VOLUME_ADJUSTMENT") << endl;}
  if(LDEBUG){cerr << "xvasp.aopts.flag(\"AFLOWIN_FLAG::PARAMS\")=" << xvasp.aopts.flag("AFLOWIN_FLAG::PARAMS") << endl;}
  if(LDEBUG){cerr << "xvasp.aopts.flag(\"AFLOWIN_FLAG::POTIM\")=" << xvasp.aopts.flag("AFLOWIN_FLAG::POTIM") << endl;}
  if(LDEBUG){cerr << "xvasp.aopts.flag(\"AFLOWIN_FLAG::PRECISION\")=" << xvasp.aopts.flag("AFLOWIN_FLAG::PRECISION") << endl;}
  if(LDEBUG){cerr << "xvasp.aopts.flag(\"AFLOWIN_FLAG::PSTRESS\")=" << xvasp.aopts.flag("AFLOWIN_FLAG::PSTRESS") << endl;}
  if(LDEBUG){cerr << "xvasp.aopts.flag(\"AFLOWIN_FLAG::QE\")=" << xvasp.aopts.flag("AFLOWIN_FLAG::QE") << endl;}
  if(LDEBUG){cerr << "xvasp.aopts.flag(\"AFLOWIN_FLAG::RELAX_MODE\")=" << xvasp.aopts.flag("AFLOWIN_FLAG::RELAX_MODE") << endl;}
  if(LDEBUG){cerr << "xvasp.aopts.flag(\"AFLOWIN_FLAG::RELAX_TYPE\")=" << xvasp.aopts.flag("AFLOWIN_FLAG::RELAX_TYPE") << endl;}
  if(LDEBUG){cerr << "xvasp.aopts.flag(\"AFLOWIN_FLAG::RELAX_TYPE\")=" << xvasp.aopts.flag("AFLOWIN_FLAG::RELAX_TYPE") << endl;}
  if(LDEBUG){cerr << "xvasp.aopts.flag(\"AFLOWIN_FLAG::TYPE\")=" << xvasp.aopts.flag("AFLOWIN_FLAG::TYPE") << endl;}
  if(LDEBUG){cerr << "xvasp.aopts.flag(\"AFLOWIN_FLAG::VASP\")=" << xvasp.aopts.flag("AFLOWIN_FLAG::VASP") << endl;}
  if(LDEBUG){cerr << "xvasp.aopts.flag(\"AFLOWIN_FLAG::VOLUME_MULTIPLY_EQUAL\")=" << xvasp.aopts.flag("AFLOWIN_FLAG::VOLUME_MULTIPLY_EQUAL") << endl;}
  if(LDEBUG){cerr << "xvasp.aopts.flag(\"AFLOWIN_FLAG::VOLUME_PLUS_EQUAL\")=" << xvasp.aopts.flag("AFLOWIN_FLAG::VOLUME_PLUS_EQUAL") << endl;}
  if(LDEBUG){cerr << "xvasp.aopts.flag(\"AVASP_flag_CONVERT_UNIT_CELL_CARTESIAN\")=" << xvasp.aopts.flag("AVASP_flag_CONVERT_UNIT_CELL_CARTESIAN") << endl;}
  if(LDEBUG){cerr << "xvasp.aopts.flag(\"AVASP_flag_CONVERT_UNIT_CELL_COMPACT\")=" << xvasp.aopts.flag("AVASP_flag_CONVERT_UNIT_CELL_COMPACT") << endl;}
  if(LDEBUG){cerr << "xvasp.aopts.flag(\"AVASP_flag_CONVERT_UNIT_CELL_FRACTIONAL\")=" << xvasp.aopts.flag("AVASP_flag_CONVERT_UNIT_CELL_FRACTIONAL") << endl;}
  if(LDEBUG){cerr << "xvasp.aopts.flag(\"AVASP_flag_CONVERT_UNIT_CELL_INCELL\")=" << xvasp.aopts.flag("AVASP_flag_CONVERT_UNIT_CELL_INCELL") << endl;}
  if(LDEBUG){cerr << "xvasp.aopts.flag(\"AVASP_flag_CONVERT_UNIT_CELL_INCOMPACT\")=" << xvasp.aopts.flag("AVASP_flag_CONVERT_UNIT_CELL_INCOMPACT") << endl;}
  if(LDEBUG){cerr << "xvasp.aopts.flag(\"AVASP_flag_CONVERT_UNIT_CELL_MINKOWSKI\")=" << xvasp.aopts.flag("AVASP_flag_CONVERT_UNIT_CELL_MINKOWSKI") << endl;}
  if(LDEBUG){cerr << "xvasp.aopts.flag(\"AVASP_flag_CONVERT_UNIT_CELL_NIGGLI\")=" << xvasp.aopts.flag("AVASP_flag_CONVERT_UNIT_CELL_NIGGLI") << endl;}
  if(LDEBUG){cerr << "xvasp.aopts.flag(\"AVASP_flag_CONVERT_UNIT_CELL_PRESERVE\")=" << xvasp.aopts.flag("AVASP_flag_CONVERT_UNIT_CELL_PRESERVE") << endl;}
  if(LDEBUG){cerr << "xvasp.aopts.flag(\"AVASP_flag_CONVERT_UNIT_CELL_STANDARD_CONVENTIONAL\")=" << xvasp.aopts.flag("AVASP_flag_CONVERT_UNIT_CELL_STANDARD_CONVENTIONAL") << endl;}
  if(LDEBUG){cerr << "xvasp.aopts.flag(\"AVASP_flag_CONVERT_UNIT_CELL_STANDARD_PRIMITIVE\")=" << xvasp.aopts.flag("AVASP_flag_CONVERT_UNIT_CELL_STANDARD_PRIMITIVE") << endl;}
  if(LDEBUG){cerr << "xvasp.aopts.flag(\"AVASP_flag_CONVERT_UNIT_CELL_WIGNERSEITZ\")=" << xvasp.aopts.flag("AVASP_flag_CONVERT_UNIT_CELL_WIGNERSEITZ") << endl;}
  if(LDEBUG){cerr << "xvasp.aopts.flag(\"FLAG::ABMIX_SET\")=" << xvasp.aopts.flag("FLAG::ABMIX_SET") << endl;}
  if(LDEBUG){cerr << "xvasp.aopts.flag(\"FLAG::ALGO_PRESERVED\")=" << xvasp.aopts.flag("FLAG::ALGO_PRESERVED") << endl;}
  if(LDEBUG){cerr << "xvasp.aopts.flag(\"FLAG::ALGO_SET\")=" << xvasp.aopts.flag("FLAG::ALGO_SET") << endl;}
  if(LDEBUG){cerr << "xvasp.aopts.flag(\"FLAG::AVASP_AUTO_MAGMOM\")=" << xvasp.aopts.flag("FLAG::AVASP_AUTO_MAGMOM") << endl;}
  if(LDEBUG){cerr << "xvasp.aopts.flag(\"FLAG::AVASP_AUTO_PSEUDOPOTENTIALS\")=" << xvasp.aopts.flag("FLAG::AVASP_AUTO_PSEUDOPOTENTIALS") << endl;}
  if(LDEBUG){cerr << "xvasp.aopts.flag(\"FLAG::AVASP_BADER\")=" << xvasp.aopts.flag("FLAG::AVASP_BADER") << endl;}
  if(LDEBUG){cerr << "xvasp.aopts.flag(\"FLAG::AVASP_CHGCAR\")=" << xvasp.aopts.flag("FLAG::AVASP_CHGCAR") << endl;}
  if(LDEBUG){cerr << "xvasp.aopts.flag(\"FLAG::AVASP_ELF\")=" << xvasp.aopts.flag("FLAG::AVASP_ELF") << endl;}
  if(LDEBUG){cerr << "xvasp.aopts.flag(\"FLAG::AVASP_FORCE_NOLDAU\")=" << xvasp.aopts.flag("FLAG::AVASP_FORCE_NOLDAU") << endl;}
  if(LDEBUG){cerr << "xvasp.aopts.flag(\"FLAG::AVASP_KPPRA\")=" << xvasp.aopts.flag("FLAG::AVASP_KPPRA") << endl;}
  if(LDEBUG){cerr << "xvasp.aopts.flag(\"FLAG::AVASP_LDAU1\")=" << xvasp.aopts.flag("FLAG::AVASP_LDAU1") << endl;}
  if(LDEBUG){cerr << "xvasp.aopts.flag(\"FLAG::AVASP_LDAU2\")=" << xvasp.aopts.flag("FLAG::AVASP_LDAU2") << endl;}
  if(LDEBUG){cerr << "xvasp.aopts.flag(\"FLAG::AVASP_LDAU_ADIABATIC\")=" << xvasp.aopts.flag("FLAG::AVASP_LDAU_ADIABATIC") << endl;}
  if(LDEBUG){cerr << "xvasp.aopts.flag(\"FLAG::AVASP_LDAU_CUTOFF\")=" << xvasp.aopts.flag("FLAG::AVASP_LDAU_CUTOFF") << endl;}
  if(LDEBUG){cerr << "xvasp.aopts.flag(\"FLAG::AVASP_LSCOUPLING\")=" << xvasp.aopts.flag("FLAG::AVASP_LSCOUPLING") << endl;}
  if(LDEBUG){cerr << "xvasp.aopts.flag(\"FLAG::AVASP_RELAX_FORCES\")=" << xvasp.aopts.flag("FLAG::AVASP_RELAX_FORCES") << endl;}
  if(LDEBUG){cerr << "xvasp.aopts.flag(\"FLAG::AVASP_SKIP_NOMIX\")=" << xvasp.aopts.flag("FLAG::AVASP_SKIP_NOMIX") << endl;}
  if(LDEBUG){cerr << "xvasp.aopts.flag(\"FLAG::AVASP_SPIN\")=" << xvasp.aopts.flag("FLAG::AVASP_SPIN") << endl;}
  if(LDEBUG){cerr << "xvasp.aopts.flag(\"FLAG::AVASP_SPIN_REMOVE_RELAX_1\")=" << xvasp.aopts.flag("FLAG::AVASP_SPIN_REMOVE_RELAX_1") << endl;}
  if(LDEBUG){cerr << "xvasp.aopts.flag(\"FLAG::AVASP_SPIN_REMOVE_RELAX_2\")=" << xvasp.aopts.flag("FLAG::AVASP_SPIN_REMOVE_RELAX_2") << endl;}
  if(LDEBUG){cerr << "xvasp.aopts.flag(\"FLAG::AVASP_WAVECAR\")=" << xvasp.aopts.flag("FLAG::AVASP_WAVECAR") << endl;}
  if(LDEBUG){cerr << "xvasp.aopts.flag(\"FLAG::EXTRA_INCAR\")=" << xvasp.aopts.flag("FLAG::EXTRA_INCAR") << endl;}
  if(LDEBUG){cerr << "xvasp.aopts.flag(\"FLAG::IVDW_SET\")=" << xvasp.aopts.flag("FLAG::IVDW_SET") << endl;}
  if(LDEBUG){cerr << "xvasp.aopts.flag(\"FLAG::PRECISION_PRESERVED\")=" << xvasp.aopts.flag("FLAG::PRECISION_PRESERVED") << endl;}
  if(LDEBUG){cerr << "xvasp.aopts.flag(\"FLAG::PRECISION_SET\")=" << xvasp.aopts.flag("FLAG::PRECISION_SET") << endl;}
  if(LDEBUG){cerr << "xvasp.aopts.flag(\"FLAG::VOLUME_PRESERVED\")=" << xvasp.aopts.flag("FLAG::VOLUME_PRESERVED") << endl;}
  if(LDEBUG){cerr << "xvasp.aopts.flag(\"FLAGS::AVASP_AAPL=OFF\")=" << xvasp.aopts.flag("FLAGS::AVASP_AAPL=OFF") << endl;}
  if(LDEBUG){cerr << "xvasp.aopts.flag(\"FLAGS::AVASP_APL=OFF\")=" << xvasp.aopts.flag("FLAGS::AVASP_APL=OFF") << endl;}
  if(LDEBUG){cerr << "xvasp.aopts.flag(\"FLAGS::AVASP_NEIGHBOURS=OFF\")=" << xvasp.aopts.flag("FLAGS::AVASP_NEIGHBOURS=OFF") << endl;}
  if(LDEBUG){cerr << "xvasp.aopts.flag(\"FLAGS::AVASP_QHA=OFF\")=" << xvasp.aopts.flag("FLAGS::AVASP_QHA=OFF") << endl;}
  if(LDEBUG){cerr << "xvasp.aopts.flag(\"FLAGS::AVASP_SYMMMETRY=OFF\")=" << xvasp.aopts.flag("FLAGS::AVASP_SYMMMETRY=OFF") << endl;}
  if(LDEBUG){cerr << "xvasp.str=" << endl << xvasp.str << endl;}
  if(LDEBUG){cerr << "xvasp.str.bravais_lattice_type=" << xvasp.str.bravais_lattice_type << endl;}
  if(LDEBUG){cerr << "xvasp.str.bravais_lattice_variation_type=" << xvasp.str.bravais_lattice_variation_type << endl;}
  if(LDEBUG){cerr << "xvasp.str.comp_each_type=";for(uint i=0;i<xvasp.str.comp_each_type.size();i++){cerr << xvasp.str.comp_each_type[i];} cerr << endl;}
  if(LDEBUG){cerr << "xvasp.str.num_each_type=";for(uint i=0;i<xvasp.str.num_each_type.size();i++){cerr << xvasp.str.num_each_type[i];} cerr << endl;}
  if(LDEBUG){cerr << "xvasp.str.spacegroupnumber=" << xvasp.str.spacegroupnumber << endl;}
  if(LDEBUG){cerr << "xvasp.str.species=";for(uint i=0;i<xvasp.str.species.size();i++){cerr << xvasp.str.species[i];} cerr << endl;}
  if(LDEBUG){cerr << "xvasp.str.species_mass=";for(uint i=0;i<xvasp.str.species_mass.size();i++){cerr << xvasp.str.species_mass[i];} cerr << endl;}
  if(LDEBUG){cerr << "xvasp.str.species_pp=";for(uint i=0;i<xvasp.str.species_pp.size();i++){cerr << xvasp.str.species_pp[i];} cerr << endl;}
  if(LDEBUG){cerr << "xvasp.str.species_pp_ZVAL=";for(uint i=0;i<xvasp.str.species_pp_ZVAL.size();i++){cerr << xvasp.str.species_pp_ZVAL[i];} cerr << endl;}
  if(LDEBUG){cerr << "xvasp.str.species_pp_type=";for(uint i=0;i<xvasp.str.species_pp_type.size();i++){cerr << xvasp.str.species_pp_type[i];} cerr << endl;}
  if(LDEBUG){cerr << "xvasp.str.species_pp_vLDAU=";for(uint i=0;i<xvasp.str.species_pp_vLDAU.size();i++){for(uint j=0;j<xvasp.str.species_pp_vLDAU[i].size();j++){cerr << xvasp.str.species_pp_vLDAU[i][j];} cerr << endl;} cerr << endl;}
  if(LDEBUG){cerr << "xvasp.str.species_pp_version=";for(uint i=0;i<xvasp.str.species_pp_version.size();i++){cerr << xvasp.str.species_pp_version[i];} cerr << endl;}
  if(LDEBUG){cerr << "xvasp.str.species_volume=";for(uint i=0;i<xvasp.str.species_volume.size();i++){cerr << xvasp.str.species_volume[i];} cerr << endl;}
  return true;
}
...
bool AVASP_MakeSingleAFLOWIN(_xvasp& xvasp_in,stringstream &_aflowin,bool flag_WRITE,int pthread,bool flag_PRINT) {
  ...
  if(LDEBUG) cerr << "DEBUG - AVASP_MakeSingleAFLOWIN: xvasp.aopts.flag(\"AFLOWIN_FLAG::VASP\")=" << xvasp.aopts.flag("AFLOWIN_FLAG::VASP") << endl;
...
bool AVASP_MakePrototype_AFLOWIN(_AVASP_PROTO *PARAMS) {
  ...
  if(LDEBUG)  cerr << "DEBUG - AVASP_MakePrototype_AFLOWIN: string_POTENTIAL=" << string_POTENTIAL << endl;
  ...
  if(LDEBUG) cerr << "DEBUG - AVASP_MakePrototype_AFLOWIN: [0] xvasp.AVASP_potential=" << xvasp.AVASP_potential << endl;
  if(LDEBUG) cerr << "DEBUG - AVASP_MakePrototype_AFLOWIN: [0] string_POTENTIAL=" << string_POTENTIAL << endl;
  ...
  if((string_POTENTIAL!=DEFAULT_VASP_POTCAR_DIR_POTPAW_PBE &&
    ...
    if(LDEBUG) cerr << "DEBUG - AVASP_MakePrototype_AFLOWIN: [1] xvasp.AVASP_potential=" << xvasp.AVASP_potential << endl;
    if(LDEBUG) cerr << "DEBUG - AVASP_MakePrototype_AFLOWIN: [1] string_POTENTIAL=" << string_POTENTIAL << endl;
  ...
  if(LDEBUG) cerr << "DEBUG - AVASP_MakePrototype_AFLOWIN: [X] xvasp.AVASP_potential=" << xvasp.AVASP_potential << endl;
  if(LDEBUG) cerr << "DEBUG - AVASP_MakePrototype_AFLOWIN: [X] string_POTENTIAL=" << string_POTENTIAL << endl;
