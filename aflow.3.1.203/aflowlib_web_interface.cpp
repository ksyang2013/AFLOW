...
namespace aflowlib {
  uint WEB_Aflowlib_Entry_PHP(string options,ostream& oss) {
	...
	oss << "<li><span class=\"description\">" << DEFAULT_FILE_AFLOWLIB_ENTRY_OUT << ":</span>" << "[" << "<a href=\"" << url_WEB << "/\"" << html_TAB << ">entry</a>|" << "<a href=\"" << url_WEB << "/" << DEFAULT_FILE_AFLOWLIB_ENTRY_OUT << "\"" << html_TAB << ">raw</a>]" << "</li>" << endl;
	oss << "<li><span class=\"description\">" << DEFAULT_FILE_AFLOWLIB_ENTRY_JSON << ":</span>" << "[" << "<a href=\"" << url_WEB << "/?format=json\"" << html_TAB << ">entry</a>|" << "<a href=\"" << url_WEB << "/" << DEFAULT_FILE_AFLOWLIB_ENTRY_JSON << "\"" << html_TAB << ">raw</a>]" << "</li>" << endl;
      }
      if(!aentry.auid.empty()) 
	oss << "<li class='flexli'><span class=\"description\">AFLOW-UID [<a href=\"" << url_WEB << "/?auid\">auid</a>]:</span>" << aentry.auid << "</li>" << endl; // PC 180515
      if(!aentry.aurl.empty()) 
	oss << "<li class='flexli'><span class=\"description\">AFLOW-URL [<a href=\"" << url_WEB << "/?aurl\">aurl</a>]:</span>" << aentry.aurl << "</li>" << endl; // PC 180515
      if(!aentry.code.empty()) 
	oss << "<li class='flexli'><span class=\"description\"><i>Ab-initio</i> code [<a href=\"" << url_WEB << "/?code\">code</a>]:</span>" << aentry.code << (aentry.calculation_cores>1?" (MPI) ":"") << "</li>" << endl;  // PC 180515
      if(!aentry.compound.empty()) 
	oss << "<li class='flexli'><span class=\"description\">Composition per cell [<a href=\"" << url_WEB << "/?compound\">compound</a>]:</span>" << aentry.compound << "</li><!br>" << endl; // PC 180515
      if(!aentry.icsd.empty()) 
	oss << "<li class='flexli'><span class=\"description\">ICSD entry" << icsd_link << ":</span>#" << aentry.icsd << "</li><!br>" << endl;  // PC 180515
      if(!aentry.dft_type.empty()) 
	oss << "<li class='flexli'><span class=\"description\">Pseudopotentials type [<a href=\"" << url_WEB << "/?pp_type\">pp_type</a>]:</span>" << aentry.dft_type << "</li><!br>" << endl;  // PC 180515
      for(uint i=0;i<aentry.vspecies_pp.size();i++)  
	oss << "<li class='flexli'><span class=\"description\">PP - Species&middot;Version [<a href=\"" << url_WEB << "/?species_pp_version\">species_pp_version</a>]:</span>" << aentry.vspecies_pp_version.at(i) << "</li><!br>" << endl; // PC 180515
      for(uint i=0;i<aentry.vspecies_pp_ZVAL.size();i++)  
	oss << "<li class='flexli'><span class=\"description\">PP - Species&middot;ZVAL [<a href=\"" << url_WEB << "/?species_pp_ZVAL\">species_pp_ZVAL</a>]:</span>" << aentry.vspecies_pp_ZVAL.at(i) << "</li><!br>" << endl; // PC 180515
      oss << "<li class='flexli'><span class=\"description\">LDAU [T;{L};{U};{J}] [<a href=\"" << url_WEB << "/?ldau_TLUJ\">ldau_TLUJ</a>]:</span>" << (!aentry.ldau_TLUJ.empty()?aentry.ldau_TLUJ+"  (type;{angular-1};{eV};{eV}) ":"no-LDAU") << "</li>" << endl; // PC 180515
      if(aentry.calculation_time*aentry.calculation_cores>0.0) 
	oss << "<li class='flexli'><span class=\"description\">Total CPU&middot;hours [<a href=\"" << url_WEB << "/?calculation_time\">calculation_time</a>*<a href=\"" << url_WEB << "/?calculation_cores\">calculation_cores</a>]/3600:</span>" << aentry.calculation_time*aentry.calculation_cores/3600 << " hours</li>" << endl;  // PC 180515
      if(aentry.calculation_time>0.0) 
	oss << "<li class='flexli'><span class=\"description\">Total Wall-time [<a href=\"" << url_WEB << "/?calculation_time\"> calculation_time/3600</a>]:</span>" << aentry.calculation_time/3600 << " hours</li>" << endl;  // PC 180515
      if(aentry.calculation_memory>0.0)
	oss << "<li class='flexli'><span class=\"description\">Memory Used [<a href=\"" << url_WEB << "/?calculation_memory\">calculation_memory</a>]:</span>" << aentry.calculation_memory << " MB</li>" << endl;  // PC 180515
      if(aentry.calculation_cores>0) 
	oss << "<li class='flexli'><span class=\"description\">Number of cores [<a href=\"" << url_WEB << "/?calculation_cores\">calculation_cores</a>]:</span>" << aentry.calculation_cores << (aentry.calculation_cores>1?" (MPI) ":"(serial)") << "</li>" << endl; // PC 180515
      if(!aentry.node_CPU_Model.empty()) 
	oss << "<li class='flexli'><span class=\"description\">Processor - CPU Model [<a href=\"" << url_WEB << "/?node_CPU_Model\">node_CPU_Model</a>]:</span>" << (!aentry.node_CPU_Model.empty()?aentry.node_CPU_Model:"unavailable") << "</li>" << endl;  // PC 180515
      if(aentry.node_CPU_MHz>0.0) 
	oss << "<li class='flexli'><span class=\"description\">Processor - CPU MHz [<a href=\"" << url_WEB << "/?node_CPU_MHz\">node_CPU_MHz</a>]:</span>" << (aentry.node_CPU_MHz>1.0?aurostd::utype2string(aentry.node_CPU_MHz)+"MHz ":"unavailable") << " </li>" << endl;  // PC 180515
      if(!aentry.aflow_version.empty()) 
	oss << "<li class='flexli'><span class=\"description\">AFLOW Version [<a href=\"" << url_WEB << "/?aflow_version\">aflow_version</a>]:</span>" << (!aentry.aflow_version.empty()?aentry.aflow_version:"unavailable") << "</li>" << endl;  // PC 180515
      if(!aentry.catalog.empty()) 
	oss << "<li class='flexli'><span class=\"description\">AFLOW Version [<a href=\"" << url_WEB << "/?catalog\">catalog</a>]:</span>" << (!aentry.catalog.empty()?aentry.catalog:"unavailable") << "</li>" << endl;  // PC 180515
      if(!aentry.data_api.empty()) 
	oss << "<li class='flexli'><span class=\"description\">AFLOW Version [<a href=\"" << url_WEB << "/?data_api\">data_api</a>]:</span>" << (!aentry.data_api.empty()?aentry.data_api:"unavailable") << "</li>" << endl;  // PC 180515
      if(!aentry.data_source.empty()) 
	oss << "<li class='flexli'><span class=\"description\">AFLOW Version [<a href=\"" << url_WEB << "/?data_source\">data_source</a>]:</span>" << (!aentry.data_source.empty()?aentry.data_source:"unavailable") << "</li>" << endl;  // PC 180515
      if(!aentry.data_language.empty()) 
	oss << "<li class='flexli'><span class=\"description\">AFLOW Version [<a href=\"" << url_WEB << "/?data_language\">data_language</a>]:</span>" << (!aentry.data_language.empty()?aentry.data_language:"unavailable") << "</li>" << endl;  // PC 180515
      if(!aentry.error_status.empty()) 
	oss << "<li class='flexli'><span class=\"description\">AFLOW Version [<a href=\"" << url_WEB << "/?error_status\">error_status</a>]:</span>" << (!aentry.error_status.empty()?aentry.error_status:"unavailable") << "</li>" << endl;  // PC 180515
	...
	oss << "<li class='flexli'><span class=\"description\">AFLOWLIB_entry version [<a href=\"" << url_WEB << "/?aflowlib_version\">aflowlib_version</a>]:</span>" << (!aentry.aflowlib_version.empty()?aentry.aflowlib_version:"unavailable") << "</li>" << endl; // PC 180515
      if(!aentry.aflowlib_date.empty()) 
	oss << "<li class='flexli'><span class=\"description\">AFLOWLIB_entry date [<a href=\"" << url_WEB << "/?aflowlib_date\">aflowlib_date</a>]:</span>" << (!aentry.aflowlib_date.empty()?aentry.aflowlib_date:"unavailable") << "</li>" << endl;  // PC 180515
      if(!aentry.author.empty()) 
	oss << "<li class='flexli'><span class=\"description\">AFLOW Version [<a href=\"" << url_WEB << "/?author\">author</a>]:</span>" << (!aentry.author.empty()?aentry.author:"unavailable") << "</li>" << endl;  // PC 180515
      if(!aentry.corresponding.empty()) 
	oss << "<li class='flexli'><span class=\"description\">AFLOW Version [<a href=\"" << url_WEB << "/?corresponding\">corresponding</a>]:</span>" << (!aentry.corresponding.empty()?aentry.corresponding:"unavailable") << "</li>" << endl;  // PC 180515
      if(!aentry.sponsor.empty()) 
	oss << "<li class='flexli'><span class=\"description\">AFLOW Version [<a href=\"" << url_WEB << "/?sponsor\">sponsor</a>]:</span>" << (!aentry.sponsor.empty()?aentry.sponsor:"unavailable") << "</li>" << endl;  // PC 180515

      // CORMAC
      if(aentry.energy_cutoff!=AUROSTD_NAN) 
	oss << "<li class='flexli'><span class=\"description\">energy_cutoff [<a href=\"" << url_WEB << "/?energy_cutoff\">energy_cutoff</a>]:</span>" << aentry.energy_cutoff << " eV</li>" << endl; // PC 180515
      //      oss.precision(6);
      if(aentry.delta_electronic_energy_convergence!=AUROSTD_NAN) 
	oss << "<li class='flexli'><span class=\"description\">delta_electronic_energy_convergence [<a href=\"" << url_WEB << "/?delta_electronic_energy_convergence\">delta_electronic_energy_convergence</a>]:</span>" << 1000*aentry.delta_electronic_energy_convergence << " meV</li>" << endl; // PC 180515
      if(aentry.delta_electronic_energy_threshold!=AUROSTD_NAN) 
	oss << "<li class='flexli'><span class=\"description\">delta_electronic_energy_threshold [<a href=\"" << url_WEB << "/?delta_electronic_energy_threshold\">delta_electronic_energy_threshold</a>]:</span>" << 1000*aentry.delta_electronic_energy_threshold << " meV</li>" << endl; // PC 180515
  ...
  if (i==1){  //GG 170714 - removed relaxed data from orig
	  ...
	  if(aurostd::substring2bool(aentry.vfiles_WEB,DEFAULT_FILE_EDATA_ORIG_OUT)) {
		...
		<< "[<a href=\"" << url_WEB << "/" << DEFAULT_FILE_EDATA_ORIG_OUT << "\"" << html_TAB << ">" << DEFAULT_FILE_EDATA_ORIG_OUT << "</a>]" << "</li>" << endl;
	  }
  ...
  if (i==1){  //GG 170714 - removed relaxed data from orig
	  if(aurostd::substring2bool(aentry.vfiles_WEB,DEFAULT_FILE_EDATA_RELAX_OUT)) {
		...
		<< "[<a href=\"" << url_WEB << "/" << DEFAULT_FILE_EDATA_RELAX_OUT << "\"" << html_TAB << ">" << DEFAULT_FILE_EDATA_RELAX_OUT << "</a>]" << "</li>" << endl;
	  }
	}
  ...
  if (i==1){  //GG 170714 - removed relaxed data from orig
	  if(aurostd::substring2bool(aentry.vfiles_WEB,DEFAULT_FILE_EDATA_BANDS_OUT)) {
		...
		<< "[<a href=\"" << url_WEB << "/" << DEFAULT_FILE_EDATA_BANDS_OUT << "\"" << html_TAB << ">" << DEFAULT_FILE_EDATA_BANDS_OUT << "</a>]" << "</li>" << endl;
	  }
	}
    ...
    // GEENA
	oss << "<div id=\"show\" class=\"flex-container\" >" 						<< endl;  // PC 180515
  ...
  oss << "<div>Majority/Minority Spin Selection:" << endl;  // PC 180515
