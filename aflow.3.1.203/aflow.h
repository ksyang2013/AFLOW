...
// CO 180419 - global exception handling - START
class AFLOWRuntimeError : public std::runtime_error {
  public:
    AFLOWRuntimeError(const std::string& function,const std::string& message);
    AFLOWRuntimeError(const std::string& function,std::stringstream& message);
    string where();
    ~AFLOWRuntimeError() throw() {};
  private:
    string f_name;  //cannot be const &, as it goes out of scope //const string& f_name;
};
class AFLOWLogicError : public std::logic_error {
  public:
    AFLOWLogicError(const std::string& function,const std::string& message);
    AFLOWLogicError(const std::string& function,std::stringstream& message);
    string where();
    ~AFLOWLogicError() throw() {};
  private:
    string f_name;  //cannot be const &, as it goes out of scope //const string& f_name;
};
// CO 180419 - global exception handling - STOP
...
#define XHOST_README_AFLOW_SYM_TXT                XHOST.vGlobal_string.at(43)
...
#define XHOST_AFLOW_PSEUDOPOTENTIALS                   XHOST.vGlobal_string.at(66)
#define XHOST_AFLOW_PSEUDOPOTENTIALS_TXT               XHOST.vGlobal_string.at(67)
#define XHOST_AFLOW_PSEUDOPOTENTIALS_LIST_TXT          XHOST.vGlobal_string.at(68)
#define XHOST_f144468a7ccc2d3a72ba44000715efdb         XHOST.vGlobal_string.at(70)
#define XHOST_d0f1b0e47f178ae627a388d3bf65d2d2         XHOST.vGlobal_string.at(71)
#define XHOST_decf00ca3ad2fe494eea8e543e929068         XHOST.vGlobal_string.at(72)
// [OBSOLETE] #define XHOST_AFLOW_BinaryRead           XHOST.vGlobal_string.at(73)
// [OBSOLETE] #define XHOST_AFLOW_Binary_Angle_Read    XHOST.vGlobal_string.at(74)
...
string GetSpaceGroupHall(int spacegroupnumber, string directory=""); // DX 9/1/17 //DX 20180526 - add directory
