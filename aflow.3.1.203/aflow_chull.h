...
namespace chull {
  class ChullFacet: public xStream {
    public:
      ...
      double getPointPlaneDistance(const ChullPoint& point) const;
      double getPointPlaneDistance(const xvector<double>& point) const;
      double getZeroPointProjectionDistance(const ChullPoint& point) const;
      double getZeroPointProjectionDistance(const xvector<double>& point) const;
      double getVerticalDistance(const ChullPoint& point,bool zero_point_projection_only=false) const;
      double getVerticalDistance(const xvector<double>& point,bool zero_point_projection_only=false) const;
...
namespace chull {
  class ConvexHull: public xStream {
    public:
      ...
      double getDistanceToHullWithinCoordGroup(uint i_coord_group,uint i_point) const;
      double getDistanceToHullWithinCoordGroup(uint i_coord_group,const ChullPoint& point) const;
