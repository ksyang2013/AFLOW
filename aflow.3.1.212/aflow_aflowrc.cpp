...
#define AFLOWRC_DEFAULT_APL_DPM                               TRUE
#define         DEFAULT_APL_DPM                               XHOST.adefault.getattachedutype<bool>("DEFAULT_APL_DPM")
...
#define AFLOWRC_DEFAULT_APL_FREQFORMAT                        string("THZ | ALLOW_NEGATIVE")
#define         DEFAULT_APL_FREQFORMAT                        XHOST.adefault.getattachedscheme("DEFAULT_APL_FREQFORMAT")
#define AFLOWRC_DEFAULT_APL_DC                                FALSE
...
#define AFLOWRC_DEFAULT_APL_DOS                               FALSE
...
#define AFLOWRC_DEFAULT_APL_PDIS_FILE                         DEFAULT_APL_FILE_PREFIX+string("phonon_dispersion.out")
#define         DEFAULT_APL_PDIS_FILE                         XHOST.adefault.getattachedscheme("DEFAULT_APL_PDIS_FILE")
#define AFLOWRC_DEFAULT_APL_PDOS_FILE                         DEFAULT_APL_FILE_PREFIX+string("phonon_dos.out")
#define         DEFAULT_APL_PDOS_FILE                         XHOST.adefault.getattachedscheme("DEFAULT_APL_PDOS_FILE")
#define AFLOWRC_DEFAULT_APL_THERMO_FILE                       DEFAULT_APL_FILE_PREFIX+string("thermodynamic_properties.out")
#define         DEFAULT_APL_THERMO_FILE                       XHOST.adefault.getattachedscheme("DEFAULT_APL_THERMO_FILE")
#define AFLOWRC_DEFAULT_APL_DYNMAT_FILE                       DEFAULT_APL_FILE_PREFIX+string("dynamical_matrix.out")
#define         DEFAULT_APL_DYNMAT_FILE                       XHOST.adefault.getattachedscheme("DEFAULT_APL_DYNMAT_FILE")
#define AFLOWRC_DEFAULT_APL_HARMIFC_FILE                      DEFAULT_APL_FILE_PREFIX+string("harmonicIFCs.xml")
#define         DEFAULT_APL_HARMIFC_FILE                      XHOST.adefault.getattachedscheme("DEFAULT_APL_HARMIFC_FILE")
#define AFLOWRC_DEFAULT_APL_HSKPTS_FILE                       DEFAULT_APL_FILE_PREFIX+string("hskpoints.out")
#define         DEFAULT_APL_HSKPTS_FILE                       XHOST.adefault.getattachedscheme("DEFAULT_APL_HSKPTS_FILE")

// DEFAULT AAPL
//// DEFAULT AAPL VALUES
#define AFLOWRC_DEFAULT_AAPL_BTE                              string("RTA")
...
#define AFLOWRC_DEFAULT_AAPL_SUMRULE                          1e-5
...
#define AFLOWRC_DEFAULT_AAPL_ISOTOPE                          FALSE
...
#define AFLOWRC_DEFAULT_AAPL_QPOINTS_FILE                     DEFAULT_AAPL_FILE_PREFIX+string("qpoints.out")
#define         DEFAULT_AAPL_QPOINTS_FILE                     XHOST.adefault.getattachedscheme("DEFAULT_AAPL_QPOINTS_FILE")
#define AFLOWRC_DEFAULT_AAPL_IRRQPTS_FILE                     DEFAULT_AAPL_FILE_PREFIX+string("irred_qpoints.out")
#define         DEFAULT_AAPL_IRRQPTS_FILE                     XHOST.adefault.getattachedscheme("DEFAULT_AAPL_IRRQPTS_FILE")
#define AFLOWRC_DEFAULT_AAPL_FREQ_FILE                        DEFAULT_AAPL_FILE_PREFIX+string("frequencies.out")
#define         DEFAULT_AAPL_FREQ_FILE                        XHOST.adefault.getattachedscheme("DEFAULT_AAPL_FREQ_FILE")
#define AFLOWRC_DEFAULT_AAPL_GVEL_FILE                        DEFAULT_AAPL_FILE_PREFIX+string("group_velocities.out")
#define         DEFAULT_AAPL_GVEL_FILE                        XHOST.adefault.getattachedscheme("DEFAULT_AAPL_GVEL_FILE")
#define AFLOWRC_DEFAULT_AAPL_RATES_FILE                       DEFAULT_AAPL_FILE_PREFIX+string("scattering_rates_total.out")
#define         DEFAULT_AAPL_RATES_FILE                       XHOST.adefault.getattachedscheme("DEFAULT_AAPL_RATES_FILE")
#define AFLOWRC_DEFAULT_AAPL_RATES_3RD_FILE                   DEFAULT_AAPL_FILE_PREFIX+string("scattering_rates_anharmonic_3rd.out")
...
#define AFLOWRC_DEFAULT_AAPL_ISOTOPE_FILE                     DEFAULT_AAPL_FILE_PREFIX+string("scattering_rates_isotope.out")
#define         DEFAULT_AAPL_ISOTOPE_FILE                     XHOST.adefault.getattachedscheme("DEFAULT_AAPL_ISOTOPE_FILE")
#define AFLOWRC_DEFAULT_AAPL_BOUNDARY_FILE                    DEFAULT_AAPL_FILE_PREFIX+string("scattering_rates_boundary.out")
#define         DEFAULT_AAPL_BOUNDARY_FILE                    XHOST.adefault.getattachedscheme("DEFAULT_AAPL_BOUNDARY_FILE")
#define AFLOWRC_DEFAULT_AAPL_TCOND_FILE                       DEFAULT_AAPL_FILE_PREFIX+string("thermal_conductivity.out")
#define         DEFAULT_AAPL_TCOND_FILE                       XHOST.adefault.getattachedscheme("DEFAULT_AAPL_TCOND_FILE")
#define AFLOWRC_DEFAULT_AAPL_TCOND_PLOT_FILE                  DEFAULT_AAPL_FILE_PREFIX+string("thermal_conductivity.plt")
...
//DX - DoD CONRAD - START
#define AFLOWRC_MPI_OPTIONS_DOD_CONRAD                        string("") // DOD_CONRAD
#define         MPI_OPTIONS_DOD_CONRAD                        XHOST.adefault.getattachedscheme("MPI_OPTIONS_DOD_CONRAD")
#define AFLOWRC_MPI_COMMAND_DOD_CONRAD                        string("aprun -n") // DOD_CONRAD
#define         MPI_COMMAND_DOD_CONRAD                        XHOST.adefault.getattachedscheme("MPI_COMMAND_DOD_CONRAD")
#define AFLOWRC_MPI_BINARY_DIR_DOD_CONRAD                     string("~/bin/") // DOD_CONRAD
#define         MPI_BINARY_DIR_DOD_CONRAD                     XHOST.adefault.getattachedscheme("MPI_BINARY_DIR_DOD_CONRAD")
//DX - DoD CONRAD - END
...
namespace aflowrc {
  bool load_default(string schema,string schema_default) {
	...
	if(aurostd::RemoveWhiteSpaces(tokens.at(0))==schema&&!found) {
	  found=TRUE; aus=aurostd::RemoveWhiteSpacesFromTheBack(tokens.at(1));  //CO 180705 - if there are spaces between ="" and //, then the value is set to the spaces (not an empty string!)
...
namespace aflowrc {
  bool read(std::ostream& oss,bool AFLOWRC_VERBOSE) {
    ...
    aflowrc::load_default("MPI_OPTIONS_DOD_CONRAD",AFLOWRC_MPI_OPTIONS_DOD_CONRAD); 
    aflowrc::load_default("MPI_COMMAND_DOD_CONRAD",AFLOWRC_MPI_COMMAND_DOD_CONRAD); 
    aflowrc::load_default("MPI_BINARY_DIR_DOD_CONRAD",AFLOWRC_MPI_BINARY_DIR_DOD_CONRAD); 
...
namespace aflowrc {
  bool write_default(std::ostream& oss,bool AFLOWRC_VERBOSE) {
    ...
    aflowrc << "DEFAULT_APL_DCPOINTS=\"" << AFLOWRC_DEFAULT_APL_DCPOINTS << "\"" << endl;
    ...
    //DX 5/2/18 - DoD CONRAD - START
    aflowrc << "MPI_OPTIONS_DOD_CONRAD=\"" << AFLOWRC_MPI_OPTIONS_DOD_CONRAD << "\"" << "// DOD_CONRAD" << endl;
    aflowrc << "MPI_COMMAND_DOD_CONRAD=\"" << AFLOWRC_MPI_COMMAND_DOD_CONRAD << "\"" << "// DOD_CONRAD" << endl;
    aflowrc << "MPI_BINARY_DIR_DOD_CONRAD=\"" << AFLOWRC_MPI_BINARY_DIR_DOD_CONRAD << "\"" << "// DOD_CONRAD" << endl; 
    //DX 5/2/18 - DoD CONRAD - END
...
namespace aflowrc {
  bool print_aflowrc(std::ostream& oss,bool AFLOWRC_VERBOSE) {
    ...
    if(LDEBUG) oss << "XHOST.adefault.getattachedscheme(\"DEFAULT_APL_HIBERNATE\")=\"" << DEFAULT_APL_HIBERNATE << "\"" << endl;
    if(LDEBUG) oss << "XHOST.adefault.getattachedscheme(\"DEFAULT_APL_MINSHELL\")=\"" << DEFAULT_APL_MINSHELL << "\"" << endl;
    if(LDEBUG) oss << "XHOST.adefault.getattachedscheme(\"DEFAULT_APL_MINATOMS\")=\"" << DEFAULT_APL_MINATOMS << "\"" << endl;
    if(LDEBUG) oss << "XHOST.adefault.getattachedscheme(\"DEFAULT_APL_POLAR\")=\"" << DEFAULT_APL_POLAR << "\"" << endl;
    if(LDEBUG) oss << "XHOST.adefault.getattachedscheme(\"DEFAULT_APL_DMAG\")=\"" << DEFAULT_APL_DMAG << "\"" << endl;
    if(LDEBUG) oss << "XHOST.adefault.getattachedscheme(\"DEFAULT_APL_DXYZONLY\")=\"" << DEFAULT_APL_DXYZONLY << "\"" << endl;
    if(LDEBUG) oss << "XHOST.adefault.getattachedscheme(\"DEFAULT_APL_DPM\")=\"" << DEFAULT_APL_DPM << "\"" << endl;
    if(LDEBUG) oss << "XHOST.adefault.getattachedscheme(\"DEFAULT_APL_ZEROSTATE\")=\"" << DEFAULT_APL_ZEROSTATE << "\"" << endl;
    if(LDEBUG) oss << "XHOST.adefault.getattachedscheme(\"DEFAULT_APL_FREQFORMAT\")=\"" << DEFAULT_APL_FREQFORMAT << "\"" << endl;
    if(LDEBUG) oss << "XHOST.adefault.getattachedscheme(\"DEFAULT_APL_DC\")=\"" << DEFAULT_APL_DC << "\"" << endl;
    if(LDEBUG) oss << "XHOST.adefault.getattachedscheme(\"DEFAULT_APL_DCPOINTS\")=\"" << DEFAULT_APL_DCPOINTS << "\"" << endl;
    if(LDEBUG) oss << "XHOST.adefault.getattachedscheme(\"DEFAULT_APL_DOS\")=\"" << DEFAULT_APL_DOS << "\"" << endl;
    ...
    if(LDEBUG) oss << "XHOST.adefault.getattachedscheme(\"DEFAULT_APL_DOSPOINTS\")=\"" << DEFAULT_APL_DOSPOINTS << "\"" << endl;
    if(LDEBUG) oss << "XHOST.adefault.getattachedscheme(\"DEFAULT_APL_DOSSMEAR\")=\"" << DEFAULT_APL_DOSSMEAR << "\"" << endl;
    if(LDEBUG) oss << "XHOST.adefault.getattachedscheme(\"DEFAULT_APL_TP\")=\"" << DEFAULT_APL_TP << "\"" << endl;
    ...
    if(LDEBUG) oss << "XHOST.adefault.getattachedscheme(\"DEFAULT_AAPL_SUMRULE\")=\"" << DEFAULT_AAPL_SUMRULE << "\"" << endl;
    if(LDEBUG) oss << "XHOST.adefault.getattachedscheme(\"DEFAULT_AAPL_SUMRULE_MAX_ITER\")=\"" << DEFAULT_AAPL_SUMRULE_MAX_ITER << "\"" << endl;
    if(LDEBUG) oss << "XHOST.adefault.getattachedscheme(\"DEFAULT_AAPL_MIXING_COEFFICIENT\")=\"" << DEFAULT_AAPL_MIXING_COEFFICIENT << "\"" << endl;
    if(LDEBUG) oss << "XHOST.adefault.getattachedscheme(\"DEFAULT_AAPL_ISOTOPE\")=\"" << DEFAULT_AAPL_ISOTOPE << "\"" << endl;
    if(LDEBUG) oss << "XHOST.adefault.getattachedscheme(\"DEFAULT_AAPL_BOUNDARY\")=\"" << DEFAULT_AAPL_BOUNDARY << "\"" << endl;
    if(LDEBUG) oss << "XHOST.adefault.getattachedscheme(\"DEFAULT_AAPL_CUMULATIVEK\")=\"" << DEFAULT_AAPL_CUMULATIVEK << "\"" << endl;
    if(LDEBUG) oss << "XHOST.adefault.getattachedscheme(\"DEFAULT_AAPL_NANO_SIZE\")=\"" << DEFAULT_AAPL_NANO_SIZE << "\"" << endl;
    ...
    //DX 5/2/18 - DoD CONRAD - START
    if(LDEBUG) oss << "XHOST.adefault.getattachedscheme(\"MPI_OPTIONS_DOD_CONRAD\")=\"" << MPI_OPTIONS_DOD_CONRAD << "\"" << endl;
    if(LDEBUG) oss << "XHOST.adefault.getattachedscheme(\"MPI_COMMAND_DOD_CONRAD\")=\"" << MPI_COMMAND_DOD_CONRAD << "\"" << endl;
    if(LDEBUG) oss << "XHOST.adefault.getattachedscheme(\"MPI_BINARY_DIR_DOD_CONRAD\")=\"" << MPI_BINARY_DIR_DOD_CONRAD << "\"" << endl;
    //DX 5/2/18 - DoD CONRAD - END
