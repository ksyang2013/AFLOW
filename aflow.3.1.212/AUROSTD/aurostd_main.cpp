...
namespace aurostd {
  ...
  bool UncompressFile(const string& FileName,const string& command) {
  ...
  bool UncompressFile(const string& FileName) {
    string file(CleanFileName(FileName));
  ...
  bool CompressFile(const string& FileName,const string& command) {
    string file(CleanFileName(FileName));
  ...
  // ***************************************************************************
  bool ZIP2ZIP(string dir,string from,string to,bool VERBOSE) {
...
#define ErrorBarString "EEEEE  ---------------------------------------------------------------------------------------------------------------------------- "
  ...
  bool string2compressfile(const string& command,const string& StringOUTPUT,const string& FileNameOUTPUT,string mode) {
    bool out=string2file(StringOUTPUT,FileNameOUTPUT,mode);
    aurostd::execute(command+" -9fq "+FileNameOUTPUT);
    return out;
  }
  
  bool string2gzfile(const string& StringOUTPUT,const string& FileNameOUTPUT,string mode) {
    return string2compressfile("gzip",StringOUTPUT,FileNameOUTPUT,mode);
  }

  bool string2bz2file(const string& StringOUTPUT,const string& FileNameOUTPUT,string mode) {
    return string2compressfile("bzip2",StringOUTPUT,FileNameOUTPUT,mode);
  }

  bool string2xzfile(const string& StringOUTPUT,const string& FileNameOUTPUT,string mode) {
    return string2compressfile("xz",StringOUTPUT,FileNameOUTPUT,mode);
  }
  ...
  // ***************************************************************************
  // write string to file - Stefano Curtarolo
  bool stringstream2file(const stringstream& StringstreamOUTPUT,const string& FileNameOUTPUT,string mode) {
    if(mode=="POST" || mode=="APPEND") {
      stringstream FileINPUT;
      aurostd::file2stringstream(FileNameOUTPUT,FileINPUT);
      ofstream FileOUTPUT;
  ...
  bool stringstream2compressfile(const string& command,const stringstream& StringstreamOUTPUT,const string& FileNameOUTPUT,string mode) {
    bool out=stringstream2file(StringstreamOUTPUT,FileNameOUTPUT,mode);
    aurostd::execute(command+" -9fq "+FileNameOUTPUT);
    return out;
  }

  bool stringstream2gzfile(const stringstream& StringstreamOUTPUT,const string& FileNameOUTPUT,string mode) {
    return stringstream2compressfile("gzip",StringstreamOUTPUT,FileNameOUTPUT,mode);
  }

  bool stringstream2bz2file(const stringstream& StringstreamOUTPUT,const string& FileNameOUTPUT,string mode) {
    return stringstream2compressfile("bzip2",StringstreamOUTPUT,FileNameOUTPUT,mode);
  }
  
  bool stringstream2xzfile(const stringstream& StringstreamOUTPUT,const string& FileNameOUTPUT,string mode) {
    return stringstream2compressfile("xz",StringstreamOUTPUT,FileNameOUTPUT,mode);
  }
  ...
  bool MoveFile(const string& _file,const string& destination) {
    ...
    if(!aurostd::IsCommandAvailable("mv")) {
      cerr << "ERROR - aurostd::MoveFile: command \"mv\" is necessary !" << endl;
      return FALSE;
    }
    if(!aurostd::FileExist(file)) {
      cerr << "ERROR - aurostd::MoveFile: " << file << " cannot be found !" << endl;
      return FALSE;
    }
    if(!aurostd::IsDirectory(destination)){ //CO 180220 //FileExist(destination)) {
      cerr << "ERROR - aurostd::MoveFile: " << destination << " cannot be found !" << endl;
      return FALSE;
    }
  ...
  bool RenameFile(const string& _file,const string& destination) {
    string file=CleanFileName(_file);
    if(!aurostd::IsCommandAvailable("mv")) {
      cerr << "ERROR - aurostd::RenameFile: command \"mv\" is necessary !" << endl;
      return FALSE;
    }
    if(!aurostd::FileExist(file)) {
      cerr << "ERROR - aurostd::RenameFile: " << file << " cannot be found !" << endl;
      return FALSE;
    }
    aurostd::execute("mv "+file+" "+destination);
    return TRUE;
...
//  }
  ...
  bool substring2bool2(const string& strstream, const string& strsub1, bool CLEAN) {
      ...
      if(CLEAN) _strstream=aurostd::RemoveWhiteSpaces(_strstream,'"');
  ...
  bool substring2bool2(const string& strstream, const string& strsub1) {
      //  if(LDEBUG)   cerr << "bool substring2bool(const string& strstream, const string& strsub1)" << endl;
      return (bool) aurostd::substring2bool2(strstream,strsub1,FALSE);
  }
